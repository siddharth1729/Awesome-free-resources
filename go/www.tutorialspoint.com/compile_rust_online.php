...
<title>Online Rust Compiler - Online Rust Editor - Online Rust IDE - Rust Coding Online - Practice Rust Online - Execute Rust Online - Compile Rust Online - Run Rust Online</title>
<meta name="Description" content="Online Rust Compiler, Online Rust Editor, Online Rust IDE, Rust Coding Online, Practice Rust Online, Execute Rust Online, Compile Rust Online, Run Rust Online, Online Rust Interpreter, Compile and Execute Rust Online (Rust v1.19.0)"/>
<meta name="Keywords" content="Online Rust Compiler, Online Rust Editor, Online Rust IDE, Rust Coding Online, Practice Rust Online, Execute Rust Online, Compile Rust Online, Compile and Execute Rust Online (Rust v1.19.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Rust Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "rust";
var preview = 0;
var compile = "rustc -o main *.rs";
var execute = "main";
var filename = "main.rs";
var mainfile = "main.rs";
var modename = "rust";
var version = "Rust v1.19.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Rust Online";
var userid = 0;
var username = "root";
var ext = "rs";
</script>
