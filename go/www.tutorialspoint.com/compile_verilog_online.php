...
<title>Online Verilog Compiler - Online Verilog Editor - Online Verilog IDE - Verilog Coding Online - Practice Verilog Online - Execute Verilog Online - Compile Verilog Online - Run Verilog Online</title>
<meta name="Description" content="Online Verilog Compiler, Online Verilog Editor, Online Verilog IDE, Verilog Coding Online, Practice Verilog Online, Execute Verilog Online, Compile Verilog Online, Run Verilog Online, Online Verilog Interpreter, Compile and Execute Verilog Online (Icarus v10.0)"/>
<meta name="Keywords" content="Online Verilog Compiler, Online Verilog Editor, Online Verilog IDE, Verilog Coding Online, Practice Verilog Online, Execute Verilog Online, Compile Verilog Online, Compile and Execute Verilog Online (Icarus v10.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Verilog Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "verilog";
var preview = 0;
var compile = "iverilog -o main *.v";
var execute = "vvp main";
var filename = "main.v";
var mainfile = "main.v";
var modename = "verilog";
var version = "Icarus v10.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Verilog Online";
var userid = 0;
var username = "root";
var ext = "v";
</script>
