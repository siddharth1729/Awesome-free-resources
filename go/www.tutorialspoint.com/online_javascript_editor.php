...
<title>Online Javascript Compiler - Online Javascript Editor - Online Javascript IDE - Javascript Coding Online - Practice Javascript Online - Execute Javascript Online - Compile Javascript Online - Run Javascript Online</title>
<meta name="Description" content="Online Javascript Compiler, Online Javascript Editor, Online Javascript IDE, Javascript Coding Online, Practice Javascript Online, Execute Javascript Online, Compile Javascript Online, Run Javascript Online, Online Javascript Interpreter, Online Javascript Editor (Javascript)"/>
<meta name="Keywords" content="Online Javascript Compiler, Online Javascript Editor, Online Javascript IDE, Javascript Coding Online, Practice Javascript Online, Execute Javascript Online, Compile Javascript Online, Online Javascript Editor (Javascript), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="8783638"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online Javascript Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var opt = "new";
var projectid = "";
var projecttitle = "Online Javascript Editor";
var userid = 0;
var username = "root";
var ext = "htm";
</script>
