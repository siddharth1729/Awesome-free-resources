...
<title>Online Clojure Compiler - Online Clojure Editor - Online Clojure IDE - Clojure Coding Online - Practice Clojure Online - Execute Clojure Online - Compile Clojure Online - Run Clojure Online</title>
<meta name="Description" content="Online Clojure Compiler, Online Clojure Editor, Online Clojure IDE, Clojure Coding Online, Practice Clojure Online, Execute Clojure Online, Compile Clojure Online, Run Clojure Online, Online Clojure Interpreter, Execute Clojure Online (Clojure v1.8.0)"/>
<meta name="Keywords" content="Online Clojure Compiler, Online Clojure Editor, Online Clojure IDE, Clojure Coding Online, Practice Clojure Online, Execute Clojure Online, Compile Clojure Online, Execute Clojure Online (Clojure v1.8.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Clojure Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "java -jar /usr/share/java/clojure.jar -i main.clj";
var filename = "main.clj";
var mainfile = "main.clj";
var modename = "java";
var version = "Clojure v1.8.0";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Clojure Online";
var userid = 0;
var username = "root";
var ext = "clj";
</script>
