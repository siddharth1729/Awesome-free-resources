...
<title>Online Haskell Compiler - Online Haskell Editor - Online Haskell IDE - Haskell Coding Online - Practice Haskell Online - Execute Haskell Online - Compile Haskell Online - Run Haskell Online</title>
<meta name="Description" content="Online Haskell Compiler, Online Haskell Editor, Online Haskell IDE, Haskell Coding Online, Practice Haskell Online, Execute Haskell Online, Compile Haskell Online, Run Haskell Online, Online Haskell Interpreter, Compile and Execute Haskell Online (Glorious Glasgow, v8.0.2)"/>
<meta name="Keywords" content="Online Haskell Compiler, Online Haskell Editor, Online Haskell IDE, Haskell Coding Online, Practice Haskell Online, Execute Haskell Online, Compile Haskell Online, Compile and Execute Haskell Online (Glorious Glasgow, v8.0.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Haskell Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "haskell";
var preview = 0;
var compile = "ghc -O2 --make *.hs -o main -threaded -rtsopts";
var execute = "main";
var filename = "main.hs";
var mainfile = "main.hs";
var modename = "haskell";
var version = "Glorious Glasgow, v8.0.2";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Haskell Online";
var userid = 0;
var username = "root";
var ext = "hs";
</script>
