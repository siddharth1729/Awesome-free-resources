...
<head>
<meta charset="utf-8">
<title>Unity 3D Game Development (2020) - From Beginners to Masters - Tutorialspoint</title>    
<meta name="Description" content="Unity 3D Game Development (2020) - From Beginners to Masters - Why Learn Game Development with Unity?The gaming industry is a $100 billion industry worldwide. By 2021, that number is expected to near $120 billion. With Unit"/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/1088/images/course_1088_image.jpg" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;10:19:51 of High Quality Videos</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="1088"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Unity 3D Game Development (2020) - From Beginners to Masters</h1>
									<h2 class="course_header_sub">Learn Unity 3D Game Design &amp; Development. Learn C# using Unity Engine. Create 2D and 3D Games for Web, Mobile, PC &amp; Mac</h2>
									<h3>Created by
									 									  
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/three_millennials" title="View Profile Three Millennials"> <b>Three Millennials</b></a>,
									 									  Last Updated <a href="javascript:void(0);"><b>17-Mar-2020</b></a>, Language:<a href="javascript:void(0);"><b>English</b></a></h3>
								</div>
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
									   										<h1>What Will I Get ?</h1>
										<ul>
																						<li>Learn the Fundamentals of Unity And Master the Unity Game Engine</li>  
																						<li>Start from Basics to Advance and create Mind Blowing Games</li>  
																						<li>Learn how to create Multiplayer Games using Photon PUN</li>  
																						<li>Learn C# Language from scratch. A powerful modern language</li>  
																						<li>Create your own Unity 2D and Unity 3D games from Scratch using C# and Unity</li>  
																						<li>Learn your way around Unity 3D Game Engine</li>  
																						<li>Start your Own 3D Game Development Career</li>  
																					</ul>
                              <div class="clear"></div>  
										           
									  										<h1>Requirements</h1>
										<ul>
																						<li>No prior programming or Unity experience is required.</li> 
																						<li>Just a PC or Mac with good Internet connection is required.</li> 
																						<li>Rest, we will learn together everything from Scratch.</li> 
																					</ul> 
																						 
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><h1>Why Learn Game Development with Unity?</h1><p>The gaming industry is a $100 billion industry worldwide. By 2021, that number is expected to near $120 billion. With Unity being the most widely used engine to develop games across multiple platforms, there has never been a better time to get into the field. As you will learn, the types of games you can create with Unity and C# are limitless. Game development makes a great hobby, allowing you to learn a new skill and play your game with family and friends. It is also an exciting and rewarding career, where plenty of successful developers, including myself, have learned the fundamentals of game development through courses like this, and not in the traditional classroom setting. Every great game starts somewhere, so why not make it yours? While people often find coding or making games intimidating, this Unity course utilizes a unique teaching method which will allow you to gain a thorough understanding of concepts while you develop your own games. Thanks to the Unity community, you’ll be able to connect with other developers, work together on new projects, and make some incredible games!</p><p>The course is about creating games using unity game engine. You&#39;ll start learning how to create 3D games using unity game engine.</p><p><strong>In this Unity course, you will:</strong></p><ul><li><p>Master Basics Concepts of C#  .</p></li><li><p>Learning basic Functionality of unity.</p></li><li><p>Detect collisions, receive user input, and create player movements</p></li><li><p>Implement sound effects, background music, and particle effects</p></li><li><p>Learn about Assets and Navigate the Unity Engine and discover unique features such as the Asset Store</p></li><li><p>Learn and create 3 Interactive Games and also learn to create a clone of Brawl stars.</p></li></ul><h1>Who this course is for:</h1><ul><li>This course is designed for Students who are Very Interested in Developing Games Professionally or as a Hobby</li><li>People who want to learn how to make their own video games, learning to code as they go.</li><li>Anyone who has a Game Idea and wants to learn how to Code that Game into Reality.</li></ul></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="5484">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Introduction 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-5484"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-5484"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:07:32</span>
														</span>
													</a>   
													<ul class="submenu ">
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="SDVJNkRNMk9JTHBRcU9xOHo3ZDBTQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=SDVJNkRNMk9JTHBRcU9xOHo3ZDBTQT09&cid=1088/preview_video.php?vl=SDVJNkRNMk9JTHBRcU9xOHo3ZDBTQT09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Download and Installations</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5485">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">C# Basics 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-5485"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-5485"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">6 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:37:54</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Intro to Section</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="OWdEeHlWVU9mbEVIc1RnRTFrc3RJQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=OWdEeHlWVU9mbEVIc1RnRTFrc3RJQT09&cid=1088/preview_video.php?vl=OWdEeHlWVU9mbEVIc1RnRTFrc3RJQT09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Variables</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="SjB6K0VmUVRreG9EaUdGejQ1aXlVUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=SjB6K0VmUVRreG9EaUdGejQ1aXlVUT09&cid=1088/preview_video.php?vl=SjB6K0VmUVRreG9EaUdGejQ1aXlVUT09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Conditional Statements</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Switch Statements</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Loops</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5486">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Fundamentals of Unity 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5486"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5486"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:20:55</span>
														</span>
													</a>   
                                                   ...
                                                   <div class="col-md-2 padding">
                                                                                                   																...
                                                                                                   																<div class="col-md-1 padding"><span>00:01:10</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Sample Project</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="UEFKRHJqUTJBNVlNdDJ1WHRSaG1iZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=UEFKRHJqUTJBNVlNdDJ1WHRSaG1iZz09&cid=1088/preview_video.php?vl=UEFKRHJqUTJBNVlNdDJ1WHRSaG1iZz09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Basics of UI</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Physics used in unity</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5487">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">First Game 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5487"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5487"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">11 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:35:31</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Collecting Assets</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Importing Assets</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Basic Level Setup</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Working Controls</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:19:12</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Track Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:21:48</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Generate Random Obstacles</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:17:44</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Game Over Functionality</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Main Menu</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:48</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Game Over Menu</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:28:06</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Polishing Game</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:20:44</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5488">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Second Game 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5488"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5488"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">13 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:37:06</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Understanding The concept</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Player Controller</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:17:44</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Algorithm for Endless World</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
															...
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Generate Random Obstacles</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="M3hzRjBXTWRKWGIvaHpiNytyUUxvUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=M3hzRjBXTWRKWGIvaHpiNytyUUxvUT09&cid=1088/preview_video.php?vl=M3hzRjBXTWRKWGIvaHpiNytyUUxvUT09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Particle System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Sound Effects</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Ads in your Game</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Build and Publish</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:33</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> Game Resource</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
												...
												<li class="toc" data-sid="5489">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Third Game 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5489"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5489"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">11 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:33:49</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Player Controller</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:23:28</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Player Animation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:57</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Enemy Controller</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Player Attack System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:21:33</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Enemy Attack System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:24:35</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Player Enemy Death System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Antidote System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:33:31</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
												...
												<li class="toc" data-sid="5490">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Intro to Photon Pun 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5490"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5490"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:13:12</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Intro to Photon Pun</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Why Multiplayer Games?</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5491">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#69e469!important;line-height:10px!important;">Creating a Clone of Brawl Stars 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5491"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5491"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">9 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:13:52</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Collecting and Importing Packages</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
                                                                                                   																...
                                                                                                   																<div class="col-md-1 padding"><span>00:20:50</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
                                                                                                   																...
                                                                                                   																<div class="col-md-1 padding"><span>00:43:23</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Spawning Player Character</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Player Moment Synchronization</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="MUF6SHplNklkbWs1cTBqQUZQNTk4dz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=MUF6SHplNklkbWs1cTBqQUZQNTk4dz09&cid=1088/preview_video.php?vl=MUF6SHplNklkbWs1cTBqQUZQNTk4dz09&cid=1088" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Weapon Functionality</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Game Over Functionality and Polishing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
							...
							<div class="panel large-panel">
									...
									<img src="https://www.tutorialspoint.com/assets/profiles/157830/profile/200_51301-1577364879.png" title="Three Millennials"/>
									<h4><a href='https://www.tutorialspoint.com/videotutorials/profile/three_millennials' target='_blank' title='View Three Millennials Profile '>Three Millennials</a></h4>
									<h5>Development | Programming | Entrepreneurship | Teaching</h5>
									<p><p><strong>Three Millennials&nbsp;</strong></p><p><strong>We transform students who are just beginners into paid professionals.&nbsp;</strong></p><p>We have over <strong>40,000+ Happy Students</strong> Learning from our courses. Our courses diversify from Web Development to Mobile App Development (Both iOS and Android Development) to Python Programming, Machine Learning, Artificial Intelligence, and much more.</p><p><strong>We believe that the knowledge we share today will become the leading experience for tomorrow.</strong> Our primary motive is to help others learn variety of skills and give them sufficient knowledge, so they can excel in their careers.</p><p>Feel free to reach out to us with any questions you have regarding our Courses or any questions for that matter.</p><p>We are passionate about helping people reveal their hidden talents and help them learn the skill they are ardent about.</p></p>             
								</div>
								
								<h3>More Courses from <a href="https://www.tutorialspoint.com/videotutorials/profile/three_millennials" target="_blank" title="View Three Millennials Profile">Three Millennials </a></h3><div>								<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse1087">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/android_game_development_crash_course_for_beginners/index.asp" title="Android Game Development Crash Course For Beginners">
													<div class="card-content" title="Android Game Development Crash Course For Beginners"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/1087/images/course_1087_image.jpg?t=1585073628" alt="Android Game Development Crash Course For Beginners Image" />
														<div class="card-title" title="Android Game Development Crash Course For Beginners">Android Game Development Crash...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													...
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='1087'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
								  ...
								  <div class="clear"></div>
									...
									<div class="card center" id="divCourse954">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/sikuli_automation_using_java_and_python_plus_5_kickass_projects/index.asp" title="Sikuli Automation Using Java and Python + 5 Kickass Projects">
													<div class="card-content" title="Sikuli Automation Using Java and Python + 5 Kickass Projects"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/954/images/course_954_image.png?t=1585073628" alt="Sikuli Automation Using Java and Python + 5 Kickass Projects Image" />
														<div class="card-title" title="Sikuli Automation Using Java and Python + 5 Kickass Projects">Sikuli Automation Using Java a...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													<div class="col-sm-6 col-7 text-center">
														...
														<strike>&#8377;13930</strike>&nbsp;&nbsp;<i class="fa fa-rupee-sign"></i>&nbsp;693																											</div>							
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='954'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
								  ...
								  <div class="clear"></div>
																...
																<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse949">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/how_to_create_tic_tac_toe_game_for_iphone_using_swift_in_xcode_ios_app/index.asp" title="How to create Tic-Tac-Toe Game for iPhone using Swift in Xcode - iOS App">
													<div class="card-content" title="How to create Tic-Tac-Toe Game for iPhone using Swift in Xcode - iOS App"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/949/images/course_949_image.png?t=1585073628" alt="How to create Tic-Tac-Toe Game for iPhone using Swift in Xcode - iOS App Image" />
														<div class="card-title" title="How to create Tic-Tac-Toe Game for iPhone using Swift in Xcode - iOS App">How to create Tic-Tac-Toe Game...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													<div class="col-sm-6 col-7 text-center">
														...
														<strike>&#8377;6930</strike>&nbsp;&nbsp;<i class="fa fa-rupee-sign"></i>&nbsp;693																											</div>							
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='949'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
