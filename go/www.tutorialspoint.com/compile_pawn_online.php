...
<title>Online Pawn Compiler - Online Pawn Editor - Online Pawn IDE - Pawn Coding Online - Practice Pawn Online - Execute Pawn Online - Compile Pawn Online - Run Pawn Online</title>
<meta name="Description" content="Online Pawn Compiler, Online Pawn Editor, Online Pawn IDE, Pawn Coding Online, Practice Pawn Online, Execute Pawn Online, Compile Pawn Online, Run Pawn Online, Online Pawn Interpreter, Compile and Execute Pawn Online (Pawn v4.0.56)"/>
<meta name="Keywords" content="Online Pawn Compiler, Online Pawn Editor, Online Pawn IDE, Pawn Coding Online, Practice Pawn Online, Execute Pawn Online, Compile Pawn Online, Compile and Execute Pawn Online (Pawn v4.0.56), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Pawn Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "pawn";
var preview = 0;
var compile = "pawncc -i./ *.p -omain.amx";
var execute = "pawnrun main.amx";
var filename = "main.p";
var mainfile = "main.p";
var modename = "c_cpp";
var version = "Pawn v4.0.56";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Pawn Online";
var userid = 0;
var username = "root";
var ext = "p";
</script>
