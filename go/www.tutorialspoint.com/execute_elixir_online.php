...
<title>Online Elixir Compiler - Online Elixir Editor - Online Elixir IDE - Elixir Coding Online - Practice Elixir Online - Execute Elixir Online - Compile Elixir Online - Run Elixir Online</title>
<meta name="Description" content="Online Elixir Compiler, Online Elixir Editor, Online Elixir IDE, Elixir Coding Online, Practice Elixir Online, Execute Elixir Online, Compile Elixir Online, Run Elixir Online, Online Elixir Interpreter, Execute Elixir Online (Elixir v1.4.5)"/>
<meta name="Keywords" content="Online Elixir Compiler, Online Elixir Editor, Online Elixir IDE, Elixir Coding Online, Practice Elixir Online, Execute Elixir Online, Compile Elixir Online, Execute Elixir Online (Elixir v1.4.5), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Elixir Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "elixir main.exs";
var filename = "main.exs";
var mainfile = "main.exs";
var modename = "erlang";
var version = "Elixir v1.4.5";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Elixir Online";
var userid = 0;
var username = "root";
var ext = "exs";
</script>
