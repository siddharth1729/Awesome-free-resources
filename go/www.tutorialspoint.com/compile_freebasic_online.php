...
<title>Online Fbc Compiler - Online Fbc Editor - Online Fbc IDE - Fbc Coding Online - Practice Fbc Online - Execute Fbc Online - Compile Fbc Online - Run Fbc Online</title>
<meta name="Description" content="Online Fbc Compiler, Online Fbc Editor, Online Fbc IDE, Fbc Coding Online, Practice Fbc Online, Execute Fbc Online, Compile Fbc Online, Run Fbc Online, Online Fbc Interpreter, Compile and Execute Free Basic Online (FreeBasic v1.05.0)"/>
<meta name="Keywords" content="Online Fbc Compiler, Online Fbc Editor, Online Fbc IDE, Fbc Coding Online, Practice Fbc Online, Execute Fbc Online, Compile Fbc Online, Compile and Execute Free Basic Online (FreeBasic v1.05.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Free Basic Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "fbc";
var preview = 0;
var compile = "fbc -x main *.bas";
var execute = "main";
var filename = "main.bas";
var mainfile = "main.bas";
var modename = "vbscript";
var version = "FreeBasic v1.05.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Free Basic Online";
var userid = 0;
var username = "root";
var ext = "bas";
</script>
