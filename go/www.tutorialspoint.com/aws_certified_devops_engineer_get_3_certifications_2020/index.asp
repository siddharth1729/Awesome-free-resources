...
<head>
<meta charset="utf-8">
<title>AWS Certified DevOps Engineer: Get 3 Certifications 2020 - Tutorialspoint</title>    
<meta name="Description" content="AWS Certified DevOps Engineer: Get 3 Certifications 2020 - Are you a company or a App Developer, Data Analyst, Business Analyst, Web Developer, IT administrator, Data Center Architect,&nbsp;Project Manager, Enterprise A"/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/866/images/course_866_image.jpg" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;20:41:24 of High Quality Videos</div>
								<div class="item-link"><i class="fa fa-play-circle"></i>&nbsp;154 &nbsp;Lectures</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="866"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">AWS Certified DevOps Engineer: Get 3 Certifications 2020</h1>
									<h2 class="course_header_sub">Get 3 AWS Certifications with over 22+ hours of learning, practice tests, and quizzes-Learn from industry professionals</h2>
									<h3>Created by
									 									  
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/syed_raza" title="View Profile Syed Raza"> <b>Syed Raza</b></a>,
									 									  Last Updated <a href="javascript:void(0);"><b>03-Jan-2020</b></a>, Language:<a href="javascript:void(0);"><b>English</b></a></h3>
								</div>
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
									   										<h1>What Will I Get ?</h1>
										<ul>
																						<li>Define what the AWS Cloud is and the basic global infrastructure &amp; AWS Cloud architectural principles</li>  
																						<li>Define a solution using architectural design principles based on customer requirements &amp; Provide implementation guidance based on best practices to the organization throughout the life cycle of the project</li>  
																						<li>Describe key services on the AWS platform and their common use cases (for example, compute and analytics)</li>  
																						<li>Describe basic security and compliance aspects of the AWS platform and the shared security model &amp; Define the billing, account management, and pricing models</li>  
																						<li>Implement and manage continuous delivery systems and methodologies on AWS &amp; Understand, implement, and automate security controls, governance processes, and compliance validation</li>  
																						<li>Define and deploy monitoring, metrics, and logging systems on AWS &amp; Design, manage, and maintain tools to automate operational processes</li>  
																						<li>Run Jenkins CI on AWS, implement, deploy and configure CI/CD pipelines with PHP, Python, and Java Applications</li>  
																					</ul>
                              <div class="clear"></div>  
										           
									  										<h1>Requirements</h1>
										<ul>
																						<li>AWS FREE Tier account is needed. You would require a valid credit card for AWS account creation</li> 
																						<li>Be able to commit to learning and homework, quizzes, and assignments</li> 
																					</ul> 
																						 
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>Are you a company or a App Developer, Data Analyst, Business Analyst, Web Developer, IT administrator, Data Center Architect, Project Manager, Enterprise Architect, or Programmer? and want to gain fundamental and intermediate level skills and enjoy a fascinating high paying career?</p><p>This gigantic course has over 22+ hours of learning, numerous practice tests, and quizzes - Learn from industry professionals!</p><p>AWS Cloud Practitioner Certification:</p><p>AWS Certified Cloud Practitioner certification course is geared for people who want to gain an overall understanding of the AWS Cloud platform. The course will provide an overall understanding of: AWS core services, security, pricing and support services.</p><p>Getting this certification will enable an IT professional to significantly boost their employability portfolio. AWS is the leading cloud services organisation in the world and they have massive expansion planned for 2019. Organisations are actively looking for professionals who have knowledge of the AWS platform in order to advise them on moving towards the cloud.</p><h1>Who this course is for:</h1><ul><li>IT Professional who wish to gain additional skills and get AWS certifications</li><li>Cloud computing professionals and beginners to enhance skill set</li><li>Anyone who want to gain a solid understanding of AWS and get certified to validate skills</li></ul></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="4115">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">Introduction 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-4115"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-4115"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:26:03</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="N3F2bUM4Z2pYYmZOSCtXbGZ5bDZvZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=N3F2bUM4Z2pYYmZOSCtXbGZ5bDZvZz09&cid=866/preview_video.php?vl=N3F2bUM4Z2pYYmZOSCtXbGZ5bDZvZz09&cid=866" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Course Structure & Agenda</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="bW52UUJKZ1lvK0RTVndJYzFMUlZtZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=bW52UUJKZ1lvK0RTVndJYzFMUlZtZz09&cid=866/preview_video.php?vl=bW52UUJKZ1lvK0RTVndJYzFMUlZtZz09&cid=866" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Example of AWS Certificate</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="U1AxeldGMzUxbUduYnVIZHRPRStVQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=U1AxeldGMzUxbUduYnVIZHRPRStVQT09&cid=866/preview_video.php?vl=U1AxeldGMzUxbUduYnVIZHRPRStVQT09&cid=866" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:54</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a Billing Alert</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="4116">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Cloud Practitioner 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-4116"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-4116"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">27 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">03:44:38</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Certified Cloud Practitioner Section Intro</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:30</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What is cloud computing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Looking at the AWS Console</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Compute</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:25</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Launching an EC2 Instance</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:14</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Launching and Configuring EC2 Instances</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:39</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Identity Access Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:16:25</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Users and Groups</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Storage - S3 Buckets</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:10</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating an S3 Bucket</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Storage - Elastic Block Storage (EBS)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating an EBS Volume</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Storage - Elastic File Storage (EFS)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Relational Database Service (RDS)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:31</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a MySQL DB Instance</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Aurora Database</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> A look at Aurora DB</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:14</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Migration</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:40</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Intro to Virtual Private Cloud</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:07</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a VPC</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Route53</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:58</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Route 53 Hand-On</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Elastic Load Balancing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Demo - Elastic Load Balancers</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Management Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:23</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Demo - Management Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:41</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Messaging Tools (SQS and SNS)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="4121">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Cloud Architect 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4121"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4121"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:10:28</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Well Architected Framework</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:58</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> A look at Route53</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:30</span></div>
                                                      																<div class="clear"></div>
												...
												<li class="toc" data-sid="4123">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Certified DevOps Engineer 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4123"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4123"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">24 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">04:11:31</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Your Review & Feedback</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:25</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What You Need To Know</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Installing AWS CLI</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:50</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Automation Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:57</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Developer Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:07</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Installing & Configuring AWS SDK Toolkit for Eclipse</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using GitHub & Fork Repository</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Install Eclipse IDE Neon</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:31</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Serverless Computing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:59</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Codestar First Project Java Web Application</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Important Consideration</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Working With AWS Lambda API Gateway</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:10</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Import Java Project in Eclipse IDE Neon</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:17</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create a Branch</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:16:06</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Adding Team Member To Project</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Switch IDE & Use AWS Cloud9</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Complete Java Web Application with Elastic Beanstalk</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:40</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Configure JIRA Bug Tracking</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create a New Issue with JIRA</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Deploying WordPress Blog Using AWS CloudFormation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:21:44</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a PHP Web Application</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Working With AWS CloudFormation Template</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:53</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Working Within Eclipse for DevOps Pipeline</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:19</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Difference Between CI/CD</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:08:28</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4126">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">DevOps Engineer - Monitoring-Metrics-Logging 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4126"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4126"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">10 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:34:23</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using PowerShell With AWS</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Tools For PowerShell - Installation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:22</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> PowerShell Commands Usage With AWS</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using AWS CloudWatch For EC2 Instance</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:21</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Monitoring With AWS CloudTrail Logs</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:48</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Autoscaling</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Monitoring Billing Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:35</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Monitoring Cost Management Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Third Party Tools: CHEF-PUPPET</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Trusted Advisor</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:03</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4127">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">DevOps Engineer Security-Governance-Validation 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4127"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4127"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:30:37</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> SGV-Governance At Scale</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:54</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> SGV - Checklist</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:09</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Well Architected AWS Framework - 5 Pillars</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:58</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Best Practices CI/CD DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:36</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4129">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Jenkins CI Deployment - DevOps Engineer 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4129"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4129"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:05:49</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What You Need To Know & Introduction</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Prerequisities</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:16</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4130">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">Setting Up AWS Environment For Jenkins 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4130"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4130"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">26 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">03:54:33</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Security Groups</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Key Pair</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating AWS Instance</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:29</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Connecting to AWS Instance Putty</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:47</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Installing Jenkins, Java, NGINX</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:19</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Configuring NGINX Proxy</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:10</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Connecting to Jenkins Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Configuring SES</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Configure SMTP AWS Jenkins</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:25</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Build Server Intro</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> CreatelAM Role For BuildServer</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create Security Group- BuildServer and Key</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Spin Up Build Server Instance</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Install Java Git AWSBSCLIon BuildServer</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Connect Jenkins to Build Server</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DevOps Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Continuous Integration CI</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:51</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Connecting Jenkins with GitHub</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Testing Web-hook- First Jenkins Job</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:26</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create Environ and-app-my-ab-ap1-python</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:32</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Grand Finale- RunJob fromGithub to AWS</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:16:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Send Email Notification-Jenk Job</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Deploying full PHP Application</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Beanstalk-PHP-Env-App-lab-practice</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:25</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cleaning up AWS Environment</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:00</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Conclusion</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="4137">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">DevOps Fundamentals 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4137"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4137"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">10 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:06:09</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Meet The Instructor - DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:04</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What Is DevOps - WIIFM</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Value Of DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:08:27</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DevOps History</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:05</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Measuring DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Agile Practices That Apply To DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:51</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Source & Version Control in DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:56</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DevOps Automation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:59</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Unified Process Within DevOps</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:50</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Concept Of Git</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="4162">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">DevOps Principles and Methodology (CI/CD) 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4162"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4162"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">6 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:32:39</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Continuous Integration CI and Delivery CD</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:51</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Continuous Testing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:00</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Configuration Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:28</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Release Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:18</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Application Performance Monitoring</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:19</span></div>
                                                      																<div class="clear"></div>
												...
												<li class="toc" data-sid="4163">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS QuickSight Data Lake - Data Analytics - Bonus 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4163"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4163"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">23 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">03:07:07</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> The Structure and Details</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:05</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Your First Visual With AWS QuickSight</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:15:40</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS QuickSight User Interface</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Uploading Data To S3 Bucket</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Athena Glue: Creating New Database</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:25</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Making Connection: Athena To QuickSight</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:09</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS UI: Sample DataSet</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS Important Concepts: DataLake-Athena-Glue-S3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Upgrading QuickSight To Enterprise & Create Virtual Private Cloud (VPC)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Importing CSV File</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a Basic Filter</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:43</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating a Calculated Field</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:34</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Understanding Function Reference</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Your First Story</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:46</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Publish Your Dashboard For Sharing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Exporting Visuals</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:13</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Connecting to Twitter as a Data Source</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Autograph in QuickSight</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> How to Create AWS QuickSight Account?</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Difference Between Microsoft Power BI & AWS QuickSight</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What is AWS QuickSight Workflow</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:40</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Understanding AWS S3, Athena, and Glue</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:21</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> How to Create RDS (MySQL) Connection For QuickSight</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:58</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4170">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Architectures 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4170"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4170"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">8 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:46:28</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Web Application Service</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:30</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hosting Media and Content</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Processing Batch Jobs</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:57</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> High Availability and Fault Tolerant</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:20</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Online Advertising Environment</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> File Optimization</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:11</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Media Sharing</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Online Gaming</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="4171">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">Conclusion 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4171"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4171"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:30:59</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AWS New Pricing Calculator</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DevOps Drivers and Salary Structure</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:08:27</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Software Developer Life Cycle (SDLC)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:47</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="4172">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#f09220!important;line-height:10px!important;">AWS Resources - Study Purposes 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-4172"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-4172"></i> 
														</span>
														<span class="lec-items">
													...
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> AWS Burstable Performance Instances</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> Best Practices for Root Access Keys</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> AWS Security Audit Guidelines</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> AWS OpsWorks: Best Practices Application Servers</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> Additional Resources that you can download</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
							...
							<div class="panel large-panel">
									...
									<img src="https://www.tutorialspoint.com/assets/profiles/136040/profile/200_26721-1577337592.jpg" title="Syed Raza"/>
									<h4><a href='https://www.tutorialspoint.com/videotutorials/profile/syed_raza' target='_blank' title='View Syed Raza Profile '>Syed Raza</a></h4>
									<h5></h5>
									<p><p>Hello, my name is <strong>Syed Raza</strong> and I am passionate about teaching valuable skills to students who are motivated to learn! My goal is to help you easily achieve your goals and objectives, whether that means enhancing your existing skill set, gain productivity at workplace, differentiate yourself, learning the new technological skills that are required to improve your career.</p><p>Over the last 20 years, I&nbsp;have acquired valuable skill sand experience that allow me to provide you with great learning experience. I have numerous technical IT and developer certifications (MCSE+I, MCT, CCNA&mdash;including a&nbsp;PhD Management&mdash;which enable me to teach a variety of powerful courses, from IT to Project Management.</p><p>Providing technical and training solutions using&nbsp;AWS, Azure, Google Cloud, Red Hat OpenShift, Python, Java, JavaScript, React JS, GCP, Kubernetes, Jenkins, Ansible, and Docker</p><p>DevOps Engineer&nbsp;building&nbsp;AWS&nbsp;pipelines using&nbsp;CodeStar&nbsp;and&nbsp;CodeCommitt</p><p>Working knowledge of&nbsp;TensorFlow,&nbsp;Pytorch,&nbsp;Keras,&nbsp;Convolutional networks, and&nbsp;data science&nbsp;concepts</p><p>Of course, as my student, you are my #1 priority.&nbsp;All of my courses are designed to cater to ensure wide variety of audience. For example, if something remains unclear to you, or you need help understanding anything within my course, just send me a message and I will be happy to&nbsp;spend some one-on-one time with you&nbsp;in order to clarify and provide answers to your questions. This is to ensure you learn better and retain the knowledge.&nbsp;My courses will help you gain real world skills and knowledge and change your life today.</p><p>Thank you for your interest in my courses, and in me as an instructor. I look forward to seeing you in one of my lectures very soon.</p></p>             
								</div>
								
								<h3>More Courses from <a href="https://www.tutorialspoint.com/videotutorials/profile/syed_raza" target="_blank" title="View Syed Raza Profile">Syed Raza </a></h3><div>								<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse875">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/android_studio_for_absolute_beginners/index.asp" title="Android Studio For Absolute Beginners">
													<div class="card-content" title="Android Studio For Absolute Beginners"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/875/images/course_875_image.jpg?t=1585073709" alt="Android Studio For Absolute Beginners Image" />
														<div class="card-title" title="Android Studio For Absolute Beginners">Android Studio For Absolute Be...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													...
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='875'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
								  ...
								  <div class="clear"></div>
									...
									<div class="card center" id="divCourse868">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/aws_rekognition_machine_learning_using_python_masterclass/index.asp" title="AWS Rekognition: Machine Learning Using Python Masterclass">
													<div class="card-content" title="AWS Rekognition: Machine Learning Using Python Masterclass"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/868/images/course_868_image.jpg?t=1585073709" alt="AWS Rekognition: Machine Learning Using Python Masterclass Image" />
														<div class="card-title" title="AWS Rekognition: Machine Learning Using Python Masterclass">AWS Rekognition: Machine Learn...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													<div class="col-sm-6 col-7 text-center">
														...
														<strike>&#8377;9100</strike>&nbsp;&nbsp;<i class="fa fa-rupee-sign"></i>&nbsp;693																											</div>							
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='868'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
								  ...
								  <div class="clear"></div>
																...
																<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse861">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/aws_codepipeline_devops_ci_cd_masterclass_2019/index.asp" title="AWS CodePipeline: DevOps CI/CD Masterclass 2019">
													<div class="card-content" title="AWS CodePipeline: DevOps CI/CD Masterclass 2019"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/861/images/course_861_image.jpg?t=1585073709" alt="AWS CodePipeline: DevOps CI/CD Masterclass 2019 Image" />
														<div class="card-title" title="AWS CodePipeline: DevOps CI/CD Masterclass 2019">AWS CodePipeline: DevOps CI/CD...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													<div class="col-sm-6 col-7 text-center">
														...
														<strike>&#8377;9100</strike>&nbsp;&nbsp;<i class="fa fa-rupee-sign"></i>&nbsp;693																											</div>							
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='861'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
