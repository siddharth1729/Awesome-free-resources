...
<title>Online Brainfuck Compiler - Online Brainfuck Editor - Online Brainfuck IDE - Brainfuck Coding Online - Practice Brainfuck Online - Execute Brainfuck Online - Compile Brainfuck Online - Run Brainfuck Online</title>
<meta name="Description" content="Online Brainfuck Compiler, Online Brainfuck Editor, Online Brainfuck IDE, Brainfuck Coding Online, Practice Brainfuck Online, Execute Brainfuck Online, Compile Brainfuck Online, Run Brainfuck Online, Online Brainfuck Interpreter, Execute Brainf**k Online (Brainf**k)"/>
<meta name="Keywords" content="Online Brainfuck Compiler, Online Brainfuck Editor, Online Brainfuck IDE, Brainfuck Coding Online, Practice Brainfuck Online, Execute Brainfuck Online, Compile Brainfuck Online, Execute Brainf**k Online (Brainf**k), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Brainf**k Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "brainfuck";
var preview = 0;
var compile = "0";
var execute = "bfi main.bf";
var filename = "main.bf";
var mainfile = "main.bf";
var modename = "text";
var version = "Brainf**k";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Brainf**k Online";
var userid = 0;
var username = "root";
var ext = "bf";
</script>
