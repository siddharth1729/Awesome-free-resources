...
<title>Online Scheme Compiler - Online Scheme Editor - Online Scheme IDE - Scheme Coding Online - Practice Scheme Online - Execute Scheme Online - Compile Scheme Online - Run Scheme Online</title>
<meta name="Description" content="Online Scheme Compiler, Online Scheme Editor, Online Scheme IDE, Scheme Coding Online, Practice Scheme Online, Execute Scheme Online, Compile Scheme Online, Run Scheme Online, Online Scheme Interpreter, Execute Scheme Online (Gauche v0.9.3.3)"/>
<meta name="Keywords" content="Online Scheme Compiler, Online Scheme Editor, Online Scheme IDE, Scheme Coding Online, Practice Scheme Online, Execute Scheme Online, Compile Scheme Online, Execute Scheme Online (Gauche v0.9.3.3), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Scheme Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "gosh main.sc";
var filename = "main.sc";
var mainfile = "main.sc";
var modename = "scheme";
var version = "Gauche v0.9.3.3";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Scheme Online";
var userid = 0;
var username = "root";
var ext = "sc";
</script>
