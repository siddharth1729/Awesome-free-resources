...
<title>Online Prolog Compiler - Online Prolog Editor - Online Prolog IDE - Prolog Coding Online - Practice Prolog Online - Execute Prolog Online - Compile Prolog Online - Run Prolog Online</title>
<meta name="Description" content="Online Prolog Compiler, Online Prolog Editor, Online Prolog IDE, Prolog Coding Online, Practice Prolog Online, Execute Prolog Online, Compile Prolog Online, Run Prolog Online, Online Prolog Interpreter, Execute Prolog Online (GNU Prolog v1.4.4)"/>
<meta name="Keywords" content="Online Prolog Compiler, Online Prolog Editor, Online Prolog IDE, Prolog Coding Online, Practice Prolog Online, Execute Prolog Online, Compile Prolog Online, Execute Prolog Online (GNU Prolog v1.4.4), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Prolog Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "gprolog --consult-file main.pg";
var filename = "main.pg";
var mainfile = "main.pg";
var modename = "sh";
var version = "GNU Prolog v1.4.4";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Prolog Online";
var userid = 0;
var username = "root";
var ext = "pg";
</script>
