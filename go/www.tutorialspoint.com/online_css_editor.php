...
<title>Online Css Compiler - Online Css Editor - Online Css IDE - Css Coding Online - Practice Css Online - Execute Css Online - Compile Css Online - Run Css Online</title>
<meta name="Description" content="Online Css Compiler, Online Css Editor, Online Css IDE, Css Coding Online, Practice Css Online, Execute Css Online, Compile Css Online, Run Css Online, Online Css Interpreter, Online CSS Editor (CSS-3)"/>
<meta name="Keywords" content="Online Css Compiler, Online Css Editor, Online Css IDE, Css Coding Online, Practice Css Online, Execute Css Online, Compile Css Online, Online CSS Editor (CSS-3), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="2493964"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online CSS Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var opt = "new";
var projectid = "";
var projecttitle = "Online CSS Editor";
var userid = 0;
var username = "root";
var ext = "htm";
</script>
