...
<title>Online Groovy Compiler - Online Groovy Editor - Online Groovy IDE - Groovy Coding Online - Practice Groovy Online - Execute Groovy Online - Compile Groovy Online - Run Groovy Online</title>
<meta name="Description" content="Online Groovy Compiler, Online Groovy Editor, Online Groovy IDE, Groovy Coding Online, Practice Groovy Online, Execute Groovy Online, Compile Groovy Online, Run Groovy Online, Online Groovy Interpreter, Execute Groovy Online (Groovy v2.4.8)"/>
<meta name="Keywords" content="Online Groovy Compiler, Online Groovy Editor, Online Groovy IDE, Groovy Coding Online, Practice Groovy Online, Execute Groovy Online, Compile Groovy Online, Execute Groovy Online (Groovy v2.4.8), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Groovy Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "groovy main.groovy";
var filename = "main.groovy";
var mainfile = "main.groovy";
var modename = "groovy";
var version = "Groovy v2.4.8";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Groovy Online";
var userid = 0;
var username = "root";
var ext = "groovy";
</script>
