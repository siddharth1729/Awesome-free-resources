...
<title>Online Nimrod Compiler - Online Nimrod Editor - Online Nimrod IDE - Nimrod Coding Online - Practice Nimrod Online - Execute Nimrod Online - Compile Nimrod Online - Run Nimrod Online</title>
<meta name="Description" content="Online Nimrod Compiler, Online Nimrod Editor, Online Nimrod IDE, Nimrod Coding Online, Practice Nimrod Online, Execute Nimrod Online, Compile Nimrod Online, Run Nimrod Online, Online Nimrod Interpreter, Compile and Execute Nimrod Online (Nimrod v0.17.0)"/>
<meta name="Keywords" content="Online Nimrod Compiler, Online Nimrod Editor, Online Nimrod IDE, Nimrod Coding Online, Practice Nimrod Online, Execute Nimrod Online, Compile Nimrod Online, Compile and Execute Nimrod Online (Nimrod v0.17.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Nimrod Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "nimrod";
var preview = 0;
var compile = "nim --o:main --hints:off c *.nim";
var execute = "main";
var filename = "main.nim";
var mainfile = "main.nim";
var modename = "sh";
var version = "Nimrod v0.17.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Nimrod Online";
var userid = 0;
var username = "root";
var ext = "nim";
</script>
