...
<title>Online Python3 Compiler - Online Python3 Editor - Online Python3 IDE - Python3 Coding Online - Practice Python3 Online - Execute Python3 Online - Compile Python3 Online - Run Python3 Online</title>
<meta name="Description" content="Online Python3 Compiler, Online Python3 Editor, Online Python3 IDE, Python3 Coding Online, Practice Python3 Online, Execute Python3 Online, Compile Python3 Online, Run Python3 Online, Online Python3 Interpreter, Execute Python-3 Online (Python v3.6.2)"/>
<meta name="Keywords" content="Online Python3 Compiler, Online Python3 Editor, Online Python3 IDE, Python3 Coding Online, Practice Python3 Online, Execute Python3 Online, Compile Python3 Online, Execute Python-3 Online (Python v3.6.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Python-3 Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "python3 main.py";
var filename = "main.py";
var mainfile = "main.py";
var modename = "python";
var version = "Python v3.6.2";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Python-3 Online";
var userid = 0;
var username = "root";
var ext = "py";
</script>
