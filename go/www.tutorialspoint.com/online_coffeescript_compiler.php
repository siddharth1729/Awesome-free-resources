...
<title>Online Coffee Compiler - Online Coffee Editor - Online Coffee IDE - Coffee Coding Online - Practice Coffee Online - Execute Coffee Online - Compile Coffee Online - Run Coffee Online</title>
<meta name="Description" content="Online Coffee Compiler, Online Coffee Editor, Online Coffee IDE, Coffee Coding Online, Practice Coffee Online, Execute Coffee Online, Compile Coffee Online, Run Coffee Online, Online Coffee Interpreter, Online CoffeeScript Compiler (CoffeeScript v1.10.0)"/>
<meta name="Keywords" content="Online Coffee Compiler, Online Coffee Editor, Online Coffee IDE, Coffee Coding Online, Practice Coffee Online, Execute Coffee Online, Compile Coffee Online, Online CoffeeScript Compiler (CoffeeScript v1.10.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="1957749"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online CoffeeScript Compiler</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var compile = "0";
var execute = "0";
var filename = "main.coffee";
var mainfile = "main.coffee";
var modename = "coffee";
var version = "CoffeeScript v1.10.0";
var opt = "new";
var projectid = "";
var projecttitle = "Online CoffeeScript Compiler";
var userid = 0;
var username = "root";
var ext = "coffee";
</script>
