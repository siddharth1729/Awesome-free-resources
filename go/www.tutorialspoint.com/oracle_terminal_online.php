...
<title>Online Oracle Compiler - Online Oracle Editor - Online Oracle IDE - Oracle Coding Online - Practice Oracle Online - Execute Oracle Online - Compile Oracle Online - Run Oracle Online</title>
<meta name="Description" content="Online Oracle Compiler, Online Oracle Editor, Online Oracle IDE, Oracle Coding Online, Practice Oracle Online, Execute Oracle Online, Compile Oracle Online, Run Oracle Online, Online Oracle Interpreter, Execute SQL Online (Oracle XE 11.2.0-1.0)"/>
<meta name="Keywords" content="Online Oracle Compiler, Online Oracle Editor, Online Oracle IDE, Oracle Coding Online, Practice Oracle Online, Execute Oracle Online, Compile Oracle Online, Execute SQL Online (Oracle XE 11.2.0-1.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
var preview = 0;
var compile = "0";
var execute = "sh sql.sh";
var filename = "sql.sh";
var mainfile = "sql.sh";
var modename = "sql";
var version = "Oracle XE 11.2.0-1.0";
var opt = "new";
var projectid = "";
