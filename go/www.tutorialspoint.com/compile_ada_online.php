...
<title>Online Ada Compiler - Online Ada Editor - Online Ada IDE - Ada Coding Online - Practice Ada Online - Execute Ada Online - Compile Ada Online - Run Ada Online</title>
<meta name="Description" content="Online Ada Compiler, Online Ada Editor, Online Ada IDE, Ada Coding Online, Practice Ada Online, Execute Ada Online, Compile Ada Online, Run Ada Online, Online Ada Interpreter, Compile and Execute Ada Online (GNATMAKE v7.1.1)"/>
<meta name="Keywords" content="Online Ada Compiler, Online Ada Editor, Online Ada IDE, Ada Coding Online, Practice Ada Online, Execute Ada Online, Compile Ada Online, Compile and Execute Ada Online (GNATMAKE v7.1.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Ada Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "ada";
var preview = 0;
var compile = "gnatmake -o hello *.adb";
var execute = "hello";
var filename = "hello.adb";
var mainfile = "hello.adb";
var modename = "ada";
var version = "GNATMAKE v7.1.1";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Ada Online";
var userid = 0;
var username = "root";
var ext = "adb";
</script>
