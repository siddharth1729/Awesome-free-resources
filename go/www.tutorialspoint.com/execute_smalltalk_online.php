...
<title>Online Smalltalk Compiler - Online Smalltalk Editor - Online Smalltalk IDE - Smalltalk Coding Online - Practice Smalltalk Online - Execute Smalltalk Online - Compile Smalltalk Online - Run Smalltalk Online</title>
<meta name="Description" content="Online Smalltalk Compiler, Online Smalltalk Editor, Online Smalltalk IDE, Smalltalk Coding Online, Practice Smalltalk Online, Execute Smalltalk Online, Compile Smalltalk Online, Run Smalltalk Online, Online Smalltalk Interpreter, Execute Smalltalk Online (GNU Smalltalk v3.2.5)"/>
<meta name="Keywords" content="Online Smalltalk Compiler, Online Smalltalk Editor, Online Smalltalk IDE, Smalltalk Coding Online, Practice Smalltalk Online, Execute Smalltalk Online, Compile Smalltalk Online, Execute Smalltalk Online (GNU Smalltalk v3.2.5), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Smalltalk Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "smalltalk";
var preview = 0;
var compile = "0";
var execute = "gst main.gst";
var filename = "main.gst";
var mainfile = "main.gst";
var modename = "python";
var version = "GNU Smalltalk v3.2.5";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Smalltalk Online";
var userid = 0;
var username = "root";
var ext = "gst";
</script>
