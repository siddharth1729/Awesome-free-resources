...
<title>Online Restructure Compiler - Online Restructure Editor - Online Restructure IDE - Restructure Coding Online - Practice Restructure Online - Execute Restructure Online - Compile Restructure Online - Run Restructure Online</title>
<meta name="Description" content="Online Restructure Compiler, Online Restructure Editor, Online Restructure IDE, Restructure Coding Online, Practice Restructure Online, Execute Restructure Online, Compile Restructure Online, Run Restructure Online, Online Restructure Interpreter, Online reStructure Editor (reStructure)"/>
<meta name="Keywords" content="Online Restructure Compiler, Online Restructure Editor, Online Restructure IDE, Restructure Coding Online, Practice Restructure Online, Execute Restructure Online, Compile Restructure Online, Online reStructure Editor (reStructure), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="8711630"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online reStructure Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "restructure";
var preview = 1;
var compile = "0";
var execute = "0";
var filename = "index.rst";
var mainfile = "index.rst";
var modename = "rhtml";
var version = "reStructure";
var opt = "new";
var projectid = "";
var projecttitle = "Online reStructure Editor";
var userid = 0;
var username = "root";
var ext = "rst";
</script>
