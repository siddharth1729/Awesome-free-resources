...
<title>Online Wspace Compiler - Online Wspace Editor - Online Wspace IDE - Wspace Coding Online - Practice Wspace Online - Execute Wspace Online - Compile Wspace Online - Run Wspace Online</title>
<meta name="Description" content="Online Wspace Compiler, Online Wspace Editor, Online Wspace IDE, Wspace Coding Online, Practice Wspace Online, Execute Wspace Online, Compile Wspace Online, Run Wspace Online, Online Wspace Interpreter, Execute Whitespace Online (Whitespace)"/>
<meta name="Keywords" content="Online Wspace Compiler, Online Wspace Editor, Online Wspace IDE, Wspace Coding Online, Practice Wspace Online, Execute Wspace Online, Compile Wspace Online, Execute Whitespace Online (Whitespace), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Whitespace Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "wspace main.ws";
var filename = "main.ws";
var mainfile = "main.ws";
var modename = "text";
var version = "Whitespace";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Whitespace Online";
var userid = 0;
var username = "root";
var ext = "ws";
</script>
