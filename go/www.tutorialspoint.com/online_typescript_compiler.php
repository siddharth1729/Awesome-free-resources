...
<title>Online Typescript Compiler - Online Typescript Editor - Online Typescript IDE - Typescript Coding Online - Practice Typescript Online - Execute Typescript Online - Compile Typescript Online - Run Typescript Online</title>
<meta name="Description" content="Online Typescript Compiler, Online Typescript Editor, Online Typescript IDE, Typescript Coding Online, Practice Typescript Online, Execute Typescript Online, Compile Typescript Online, Run Typescript Online, Online Typescript Interpreter, Online TypeScript Compiler (TypeScript v2.5.2)"/>
<meta name="Keywords" content="Online Typescript Compiler, Online Typescript Editor, Online Typescript IDE, Typescript Coding Online, Practice Typescript Online, Execute Typescript Online, Compile Typescript Online, Online TypeScript Compiler (TypeScript v2.5.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="9801863"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online TypeScript Compiler</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "typescript";
var preview = 1;
var compile = "0";
var execute = "0";
var filename = "main.ts";
var mainfile = "main.ts";
var modename = "javascript";
var version = "TypeScript v2.5.2";
var opt = "new";
var projectid = "";
var projecttitle = "Online TypeScript Compiler";
var userid = 0;
var username = "root";
var ext = "ts";
</script>
