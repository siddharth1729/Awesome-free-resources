...
<title>Online Pascal Compiler - Online Pascal Editor - Online Pascal IDE - Pascal Coding Online - Practice Pascal Online - Execute Pascal Online - Compile Pascal Online - Run Pascal Online</title>
<meta name="Description" content="Online Pascal Compiler, Online Pascal Editor, Online Pascal IDE, Pascal Coding Online, Practice Pascal Online, Execute Pascal Online, Compile Pascal Online, Run Pascal Online, Online Pascal Interpreter, Compile and Execute Pascal Online (Free Pascal v3.0.2)"/>
<meta name="Keywords" content="Online Pascal Compiler, Online Pascal Editor, Online Pascal IDE, Pascal Coding Online, Practice Pascal Online, Execute Pascal Online, Compile Pascal Online, Compile and Execute Pascal Online (Free Pascal v3.0.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Pascal Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "pascal";
var preview = 0;
var compile = "fpc -vw main.pas";
var execute = "main";
var filename = "main.pas";
var mainfile = "main.pas";
var modename = "pascal";
var version = "Free Pascal v3.0.2";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Pascal Online";
var userid = 0;
var username = "root";
var ext = "pas";
</script>
