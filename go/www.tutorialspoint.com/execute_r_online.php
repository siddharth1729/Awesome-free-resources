...
<title>Online Rscript Compiler - Online Rscript Editor - Online Rscript IDE - Rscript Coding Online - Practice Rscript Online - Execute Rscript Online - Compile Rscript Online - Run Rscript Online</title>
<meta name="Description" content="Online Rscript Compiler, Online Rscript Editor, Online Rscript IDE, Rscript Coding Online, Practice Rscript Online, Execute Rscript Online, Compile Rscript Online, Run Rscript Online, Online Rscript Interpreter, Execute R Online (R v3.4.1)"/>
<meta name="Keywords" content="Online Rscript Compiler, Online Rscript Editor, Online Rscript IDE, Rscript Coding Online, Practice Rscript Online, Execute Rscript Online, Compile Rscript Online, Execute R Online (R v3.4.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute R Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "Rscript main.r";
var filename = "main.r";
var mainfile = "main.r";
var modename = "r";
var version = "R v3.4.1";
var opt = "new";
var projectid = "";
var projecttitle = "Execute R Online";
var userid = 0;
var username = "root";
var ext = "r";
</script>
