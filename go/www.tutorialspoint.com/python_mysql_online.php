...
<title>Online Pythondb Compiler - Online Pythondb Editor - Online Pythondb IDE - Pythondb Coding Online - Practice Pythondb Online - Execute Pythondb Online - Compile Pythondb Online - Run Pythondb Online</title>
<meta name="Description" content="Online Pythondb Compiler, Online Pythondb Editor, Online Pythondb IDE, Pythondb Coding Online, Practice Pythondb Online, Execute Pythondb Online, Compile Pythondb Online, Run Pythondb Online, Online Pythondb Interpreter, Execute Python MySQL Online (Python 2.7.13)"/>
<meta name="Keywords" content="Online Pythondb Compiler, Online Pythondb Editor, Online Pythondb IDE, Pythondb Coding Online, Practice Pythondb Online, Execute Pythondb Online, Compile Pythondb Online, Execute Python MySQL Online (Python 2.7.13), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Python MySQL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "python main.py";
var filename = "main.py";
var mainfile = "main.py";
var modename = "python";
var version = "Python 2.7.13";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Python MySQL Online";
var userid = 0;
var username = "root";
var ext = "py";
</script>
