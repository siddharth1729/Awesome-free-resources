...
<title>Online Rexx Compiler - Online Rexx Editor - Online Rexx IDE - Rexx Coding Online - Practice Rexx Online - Execute Rexx Online - Compile Rexx Online - Run Rexx Online</title>
<meta name="Description" content="Online Rexx Compiler, Online Rexx Editor, Online Rexx IDE, Rexx Coding Online, Practice Rexx Online, Execute Rexx Online, Compile Rexx Online, Run Rexx Online, Online Rexx Interpreter, Execute REXX Online (ooRexx v4.2.0)"/>
<meta name="Keywords" content="Online Rexx Compiler, Online Rexx Editor, Online Rexx IDE, Rexx Coding Online, Practice Rexx Online, Execute Rexx Online, Compile Rexx Online, Execute REXX Online (ooRexx v4.2.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute REXX Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "rexx main.rex";
var filename = "main.rex";
var mainfile = "main.rex";
var modename = "java";
var version = "ooRexx v4.2.0";
var opt = "new";
var projectid = "";
var projecttitle = "Execute REXX Online";
var userid = 0;
var username = "root";
var ext = "rex";
</script>
