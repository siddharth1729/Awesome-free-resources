...
<title>Online Angularjs Compiler - Online Angularjs Editor - Online Angularjs IDE - Angularjs Coding Online - Practice Angularjs Online - Execute Angularjs Online - Compile Angularjs Online - Run Angularjs Online</title>
<meta name="Description" content="Online Angularjs Compiler, Online Angularjs Editor, Online Angularjs IDE, Angularjs Coding Online, Practice Angularjs Online, Execute Angularjs Online, Compile Angularjs Online, Run Angularjs Online, Online Angularjs Interpreter, Online AngularJS Editor (AngularJS v1.3.3)"/>
<meta name="Keywords" content="Online Angularjs Compiler, Online Angularjs Editor, Online Angularjs IDE, Angularjs Coding Online, Practice Angularjs Online, Execute Angularjs Online, Compile Angularjs Online, Online AngularJS Editor (AngularJS v1.3.3), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="8402566"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online AngularJS Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var modename = "html";
var version = "AngularJS v1.3.3";
var opt = "new";
var projectid = "";
var projecttitle = "Online AngularJS Editor";
var userid = 0;
var username = "root";
var ext = "htm";
</script>
