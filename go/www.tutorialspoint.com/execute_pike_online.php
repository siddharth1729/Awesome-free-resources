...
<title>Online Pike Compiler - Online Pike Editor - Online Pike IDE - Pike Coding Online - Practice Pike Online - Execute Pike Online - Compile Pike Online - Run Pike Online</title>
<meta name="Description" content="Online Pike Compiler, Online Pike Editor, Online Pike IDE, Pike Coding Online, Practice Pike Online, Execute Pike Online, Compile Pike Online, Run Pike Online, Online Pike Interpreter, Execute Pike Online (Pike v8.0)"/>
<meta name="Keywords" content="Online Pike Compiler, Online Pike Editor, Online Pike IDE, Pike Coding Online, Practice Pike Online, Execute Pike Online, Compile Pike Online, Execute Pike Online (Pike v8.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Pike Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "pike main.pike";
var filename = "main.pike";
var mainfile = "main.pike";
var modename = "c_cpp";
var version = "Pike v8.0";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Pike Online";
var userid = 0;
var username = "root";
var ext = "pike";
</script>
