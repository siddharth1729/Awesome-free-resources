...
<title>Online Kotlin Compiler - Online Kotlin Editor - Online Kotlin IDE - Kotlin Coding Online - Practice Kotlin Online - Execute Kotlin Online - Compile Kotlin Online - Run Kotlin Online</title>
<meta name="Description" content="Online Kotlin Compiler, Online Kotlin Editor, Online Kotlin IDE, Kotlin Coding Online, Practice Kotlin Online, Execute Kotlin Online, Compile Kotlin Online, Run Kotlin Online, Online Kotlin Interpreter, Compile and Execute Kotlin Online (Kotlin 1.1.4)"/>
<meta name="Keywords" content="Online Kotlin Compiler, Online Kotlin Editor, Online Kotlin IDE, Kotlin Coding Online, Practice Kotlin Online, Execute Kotlin Online, Compile Kotlin Online, Compile and Execute Kotlin Online (Kotlin 1.1.4), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Kotlin Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "kotlin";
var preview = 0;
var compile = "kotlinc main.kt -include-runtime -d main.jar";
var execute = "java -Xmx128M -Xms16M -jar main.jar";
var filename = "main.kt";
var mainfile = "main.kt";
var modename = "java";
var version = "Kotlin 1.1.4";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Kotlin Online";
var userid = 0;
var username = "root";
var ext = "kt";
</script>
