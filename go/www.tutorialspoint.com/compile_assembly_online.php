...
<title>Online Asm Compiler - Online Asm Editor - Online Asm IDE - Asm Coding Online - Practice Asm Online - Execute Asm Online - Compile Asm Online - Run Asm Online</title>
<meta name="Description" content="Online Asm Compiler, Online Asm Editor, Online Asm IDE, Asm Coding Online, Practice Asm Online, Execute Asm Online, Compile Asm Online, Run Asm Online, Online Asm Interpreter, Compile and Execute Assembly Online (Nasm v2.13.01)"/>
<meta name="Keywords" content="Online Asm Compiler, Online Asm Editor, Online Asm IDE, Asm Coding Online, Practice Asm Online, Execute Asm Online, Compile Asm Online, Compile and Execute Assembly Online (Nasm v2.13.01), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
var langid = "asm";
var preview = 0;
var compile = "nasm -f elf *.asm; ld -m elf_i386 -s -o demo *.o";
var execute = "demo";
var filename = "main.asm";
var mainfile = "main.asm";
var modename = "assembly_x86";
var version = "Nasm v2.13.01";
var opt = "new";
var projectid = "";
