...
<title>Online Falcon Compiler - Online Falcon Editor - Online Falcon IDE - Falcon Coding Online - Practice Falcon Online - Execute Falcon Online - Compile Falcon Online - Run Falcon Online</title>
<meta name="Description" content="Online Falcon Compiler, Online Falcon Editor, Online Falcon IDE, Falcon Coding Online, Practice Falcon Online, Execute Falcon Online, Compile Falcon Online, Run Falcon Online, Online Falcon Interpreter, Execute Falcon Online (Falcon v0.9.6.8 (Chimera))"/>
<meta name="Keywords" content="Online Falcon Compiler, Online Falcon Editor, Online Falcon IDE, Falcon Coding Online, Practice Falcon Online, Execute Falcon Online, Compile Falcon Online, Execute Falcon Online (Falcon v0.9.6.8 (Chimera)), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Falcon Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "falcon main.fl";
var filename = "main.fl";
var mainfile = "main.fl";
var modename = "sh";
var version = "Falcon v0.9.6.8 (Chimera)";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Falcon Online";
var userid = 0;
var username = "root";
var ext = "fl";
</script>
