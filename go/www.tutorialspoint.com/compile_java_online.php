...
<title>Online Java Compiler - Online Java Editor - Online Java IDE - Java Coding Online - Practice Java Online - Execute Java Online - Compile Java Online - Run Java Online</title>
<meta name="Description" content="Online Java Compiler, Online Java Editor, Online Java IDE, Java Coding Online, Practice Java Online, Execute Java Online, Compile Java Online, Run Java Online, Online Java Interpreter, Compile and Execute Java Online (JDK 1.8.0)"/>
<meta name="Keywords" content="Online Java Compiler, Online Java Editor, Online Java IDE, Java Coding Online, Practice Java Online, Execute Java Online, Compile Java Online, Compile and Execute Java Online (JDK 1.8.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Java Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Java Online";
var userid = 0;
var username = "root";
var ext = "java";
</script>
