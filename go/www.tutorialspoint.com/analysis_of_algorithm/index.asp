...
<head>
<meta charset="utf-8">
<title>Analysis of Algorithm - Tutorialspoint</title>    
<meta name="Description" content="Analysis of Algorithm - Analysis of Algorithm is an important part of a broader computational complexity theory, which provides theoretical estimates for the resources needed by any al"/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/289/images/course_289_image.png" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;07:18:41 of High Quality Videos</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="289"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Analysis of Algorithm</h1>
									...
									<h3>Created by
									 ...
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/Arnab-Chakraborty" title="View Profile Arnab Chakraborty"> <b>Arnab Chakraborty</b></a>,
									 									  Last Updated <a href="javascript:void(0);"><b>07-Aug-2019</b></a>, Language:<a href="javascript:void(0);"><b>English</b></a></h3>
								</div>
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
										...
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>Analysis of Algorithm is an important part of a broader computational complexity theory, which provides theoretical estimates for the resources needed by any algorithm which solves a given computational problem. These estimates provide an insight into reasonable directions of search for efficient algorithms. This video tutorial will give you a great understanding on Analysis of Algorithm needed to understand the complexity of enterprise level applications and need of algorithms, and data structures.</p><h1>Audience</h1><p>This video tutorial is designed for students interested in learning Analysis of Algorithm and its applications. Enthusiastic readers who would like to know more about algorithms and those who wish to implement algorithms themselves may start from here. These video classes have been developed based on the latest GATE syllabus and will be useful for undergraduate students of Computer Science and Information Technology as well as those preparing for GATE exams. It will also be helpful for students in preparing them for their Engineering Syllabus.</p></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="1431">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Analysis of Algorithm 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-1431"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-1431"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:01:03</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Analysis of Algorithms - Getting Started</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="Wlh2Q3hKVlQ2VUhxc1RyNnJDa1l1UT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=Wlh2Q3hKVlQ2VUhxc1RyNnJDa1l1UT09&cid=289/preview_video.php?vl=Wlh2Q3hKVlQ2VUhxc1RyNnJDa1l1UT09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:03</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="1432">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Algorithm Introduction 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-1432"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-1432"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:03:22</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Analysis of Algorithm - Definition</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="OWhzdTJBZFdmWEs1SEtGaXhqb2hzQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=OWhzdTJBZFdmWEs1SEtGaXhqb2hzQT09&cid=289/preview_video.php?vl=OWhzdTJBZFdmWEs1SEtGaXhqb2hzQT09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
												...
												<li class="toc" data-sid="1433">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Complexity of Algorithm 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1433"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1433"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">7 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:26:52</span>
														</span>
													</a>   
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="UWpxU0FHektOQlh5Rk1PZjR6c0Zsdz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=UWpxU0FHektOQlh5Rk1PZjR6c0Zsdz09&cid=289/preview_video.php?vl=UWpxU0FHektOQlh5Rk1PZjR6c0Zsdz09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="ajVhbE1ETU92VVhnM1lKMHlKRDIxdz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=ajVhbE1ETU92VVhnM1lKMHlKRDIxdz09&cid=289/preview_video.php?vl=ajVhbE1ETU92VVhnM1lKMHlKRDIxdz09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Asymptotic Notations GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Asymptotic Notations GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Time Complexity GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1435">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Algorithm and Classification 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1435"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1435"></i> 
														</span>
														<span class="lec-items">
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="eHRwWGV6NEhRRVhYZS8vYmlFSE0xUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=eHRwWGV6NEhRRVhYZS8vYmlFSE0xUT09&cid=289/preview_video.php?vl=eHRwWGV6NEhRRVhYZS8vYmlFSE0xUT09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
												...
												<li class="toc" data-sid="1437">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Elementary Data Structure 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1437"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1437"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">20 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:28:26</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Sparse Matrix Another Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Array GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Stack GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Tree GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Tree Traversals GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Tree Traversals GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="V2NkdzIwY3FlcHk5bE5YcHFGdU5iZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=V2NkdzIwY3FlcHk5bE5YcHFGdU5iZz09&cid=289/preview_video.php?vl=V2NkdzIwY3FlcHk5bE5YcHFGdU5iZz09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Search Tree GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Search Tree GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AVL Search Tree GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Sorting GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Sorting GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hashing GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:34</span></div>
                                                      																<div class="clear"></div>
												...
												<li class="toc" data-sid="1442">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;"> Sets and Set Operations 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1442"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1442"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:31:10</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Sets and Disjoint Set Union</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Simple Set Union and Simple Set Find Algorithms</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Weighted Union Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Collapsing Find Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1444">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Recursion 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1444"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1444"></i> 
														</span>
														<span class="lec-items">
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="TmdpaWxFd3U4ZGREZWRSL1BVb1FoZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=TmdpaWxFd3U4ZGREZWRSL1BVb1FoZz09&cid=289/preview_video.php?vl=TmdpaWxFd3U4ZGREZWRSL1BVb1FoZz09&cid=289" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Recursion GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Recursion GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1446">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;"> Divide and Conquer 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1446"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1446"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:28:17</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Divide and Conquer Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1447">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;"> The Greedy Method 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1447"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1447"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">5 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:30:20</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Properties of Greedy Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:25</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> A Sample Greedy Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Greedy Method Job Sequencing With Deadline</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Greedy Algorithm GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Greedy Method Job Sequencing With Deadline Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1449">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;"> Dynamic Programming 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1449"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1449"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">7 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:54:47</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Programming Matrix Chain Multiplication</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:49</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Programming Matrix Chain Multiplication - Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Matrix Multiplication GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Programming Travelling Salesman Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Programming Travelling Salesman Problem - Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Knapsack Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Knapsack Algorithm and Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1450">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Back Tracking Algorithm 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1450"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1450"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">7 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:54:45</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Algorithm N-Queen&rsquo;s Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Algorithm 8-Queen&rsquo;s Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:31</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Algorithm N-Queen&rsquo;s Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Hamiltonian Cycles</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Algorithm For Hamiltonian Cycles</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:10</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Graph Coloring Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:02</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Back Tracking Graph Coloring Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1451">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">Branch and Bound 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1451"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1451"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:15:32</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Branch and Bound 15-Puzzle Problem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:43</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Branch and Bound 15-Puzzle Problem Game Tree</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:49</span></div>
                                                      																<div class="clear"></div>
												...
												<li class="toc" data-sid="1452">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1cc172!important;line-height:10px!important;">NP-Hard and NP - Complete Problems 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1452"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1452"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:18:15</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> NP-Hard and NP - Complete Problems</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Non-Deterministic Algorithms</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Some Important Issues on P And NP Algorithms</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
