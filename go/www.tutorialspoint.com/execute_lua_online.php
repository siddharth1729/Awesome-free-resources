...
<title>Online Lua Compiler - Online Lua Editor - Online Lua IDE - Lua Coding Online - Practice Lua Online - Execute Lua Online - Compile Lua Online - Run Lua Online</title>
<meta name="Description" content="Online Lua Compiler, Online Lua Editor, Online Lua IDE, Lua Coding Online, Practice Lua Online, Execute Lua Online, Compile Lua Online, Run Lua Online, Online Lua Interpreter, Execute Lua Online (Lua v5.3.4)"/>
<meta name="Keywords" content="Online Lua Compiler, Online Lua Editor, Online Lua IDE, Lua Coding Online, Practice Lua Online, Execute Lua Online, Compile Lua Online, Execute Lua Online (Lua v5.3.4), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Lua Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "lua main.lua";
var filename = "main.lua";
var mainfile = "main.lua";
var modename = "lua";
var version = "Lua v5.3.4";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Lua Online";
var userid = 0;
var username = "root";
var ext = "lua";
</script>
