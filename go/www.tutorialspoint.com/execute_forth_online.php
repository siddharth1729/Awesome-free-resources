...
<title>Online Forth Compiler - Online Forth Editor - Online Forth IDE - Forth Coding Online - Practice Forth Online - Execute Forth Online - Compile Forth Online - Run Forth Online</title>
<meta name="Description" content="Online Forth Compiler, Online Forth Editor, Online Forth IDE, Forth Coding Online, Practice Forth Online, Execute Forth Online, Compile Forth Online, Run Forth Online, Online Forth Interpreter, Execute Forth Online (gforth v0.7.3)"/>
<meta name="Keywords" content="Online Forth Compiler, Online Forth Editor, Online Forth IDE, Forth Coding Online, Practice Forth Online, Execute Forth Online, Compile Forth Online, Execute Forth Online (gforth v0.7.3), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Forth Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "gforth main.fth -e bye";
var filename = "main.fth";
var mainfile = "main.fth";
var modename = "text";
var version = "gforth v0.7.3";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Forth Online";
var userid = 0;
var username = "root";
var ext = "fth";
</script>
