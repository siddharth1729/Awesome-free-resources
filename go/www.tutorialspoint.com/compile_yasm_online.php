...
<title>Online Yasm Compiler - Online Yasm Editor - Online Yasm IDE - Yasm Coding Online - Practice Yasm Online - Execute Yasm Online - Compile Yasm Online - Run Yasm Online</title>
<meta name="Description" content="Online Yasm Compiler, Online Yasm Editor, Online Yasm IDE, Yasm Coding Online, Practice Yasm Online, Execute Yasm Online, Compile Yasm Online, Run Yasm Online, Online Yasm Interpreter, Compile and Execute Assembly Online (Yasm v1.3.0)"/>
<meta name="Keywords" content="Online Yasm Compiler, Online Yasm Editor, Online Yasm IDE, Yasm Coding Online, Practice Yasm Online, Execute Yasm Online, Compile Yasm Online, Compile and Execute Assembly Online (Yasm v1.3.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Assembly Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "yasm";
var preview = 0;
var compile = "yasm -f elf *.asm; ld -m elf_i386 -s -o demo *.o";
var execute = "demo";
var filename = "main.asm";
var mainfile = "main.asm";
var modename = "assembly_x86";
var version = "Yasm v1.3.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Assembly Online";
var userid = 0;
var username = "root";
var ext = "asm";
</script>
