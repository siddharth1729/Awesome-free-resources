...
<title>Online Vb.net Compiler - Online Vb.net Editor - Online Vb.net IDE - Vb.net Coding Online - Practice Vb.net Online - Execute Vb.net Online - Compile Vb.net Online - Run Vb.net Online</title>
<meta name="Description" content="Online Vb.net Compiler, Online Vb.net Editor, Online Vb.net IDE, Vb.net Coding Online, Practice Vb.net Online, Execute Vb.net Online, Compile Vb.net Online, Run Vb.net Online, Online Vb.net Interpreter, Compile and Execute VB.Net Online (Mono v4.6)"/>
<meta name="Keywords" content="Online Vb.net Compiler, Online Vb.net Editor, Online Vb.net IDE, Vb.net Coding Online, Practice Vb.net Online, Execute Vb.net Online, Compile Vb.net Online, Compile and Execute VB.Net Online (Mono v4.6), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute VB.Net Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "vb.net";
var preview = 0;
var compile = "vbnc *.vb /out:main.exe";
var execute = "mono main.exe";
var filename = "main.vb";
var mainfile = "main.vb";
var modename = "vbscript";
var version = "Mono v4.6";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute VB.Net Online";
var userid = 0;
var username = "root";
var ext = "vb";
</script>
