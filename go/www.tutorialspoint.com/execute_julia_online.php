...
<title>Online Julia Compiler - Online Julia Editor - Online Julia IDE - Julia Coding Online - Practice Julia Online - Execute Julia Online - Compile Julia Online - Run Julia Online</title>
<meta name="Description" content="Online Julia Compiler, Online Julia Editor, Online Julia IDE, Julia Coding Online, Practice Julia Online, Execute Julia Online, Compile Julia Online, Run Julia Online, Online Julia Interpreter, Execute Julia Online (Julia v0.6.0)"/>
<meta name="Keywords" content="Online Julia Compiler, Online Julia Editor, Online Julia IDE, Julia Coding Online, Practice Julia Online, Execute Julia Online, Compile Julia Online, Execute Julia Online (Julia v0.6.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Julia Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "julia main.jl";
var filename = "main.jl";
var mainfile = "main.jl";
var modename = "julia";
var version = "Julia v0.6.0";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Julia Online";
var userid = 0;
var username = "root";
var ext = "jl";
</script>
