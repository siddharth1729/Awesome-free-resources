  ...
  $.app.menu = {
    ...
    change: function(defMenu) {
      ...
      if($body.is('.horizontal-layout') && !$body.hasClass('.horizontal-menu-demo')){
        ...
        $('#coursesDisplayDiv .col-md-8').removeClass('course-index-padding-40');
        $('#coursesDisplayDiv .col-md-8').addClass('course-index-padding-20');
      }
    ...
    transit: function(callback1, callback2) {
      ...
      if($body.hasClass('vertical-layout')){
        if($body.hasClass('menu-open') || $body.hasClass('menu-expanded')){
         ...
         $('#coursesDisplayDiv .col-md-8').removeClass('course-index-padding-20');
         $('#coursesDisplayDiv .col-md-8').addClass('course-index-padding-40');
