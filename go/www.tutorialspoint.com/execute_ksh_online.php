...
<title>Online Ksh Compiler - Online Ksh Editor - Online Ksh IDE - Ksh Coding Online - Practice Ksh Online - Execute Ksh Online - Compile Ksh Online - Run Ksh Online</title>
<meta name="Description" content="Online Ksh Compiler, Online Ksh Editor, Online Ksh IDE, Ksh Coding Online, Practice Ksh Online, Execute Ksh Online, Compile Ksh Online, Run Ksh Online, Online Ksh Interpreter, Execute Korn Shell (ksh) Online (Ksh, AT&T Research 93u+)"/>
<meta name="Keywords" content="Online Ksh Compiler, Online Ksh Editor, Online Ksh IDE, Ksh Coding Online, Practice Ksh Online, Execute Ksh Online, Compile Ksh Online, Execute Korn Shell (ksh) Online (Ksh, AT&T Research 93u+), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Korn Shell (ksh) Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "ksh main.ksh";
var filename = "main.ksh";
var mainfile = "main.ksh";
var modename = "sh";
var version = "Ksh, AT&T Research 93u+";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Korn Shell (ksh) Online";
var userid = 0;
var username = "root";
var ext = "ksh";
</script>
