...
<title>Online Jqueryui Compiler - Online Jqueryui Editor - Online Jqueryui IDE - Jqueryui Coding Online - Practice Jqueryui Online - Execute Jqueryui Online - Compile Jqueryui Online - Run Jqueryui Online</title>
<meta name="Description" content="Online Jqueryui Compiler, Online Jqueryui Editor, Online Jqueryui IDE, Jqueryui Coding Online, Practice Jqueryui Online, Execute Jqueryui Online, Compile Jqueryui Online, Run Jqueryui Online, Online Jqueryui Interpreter, Online jQueryUI Editor (jQueryUI (1.12))"/>
<meta name="Keywords" content="Online Jqueryui Compiler, Online Jqueryui Editor, Online Jqueryui IDE, Jqueryui Coding Online, Practice Jqueryui Online, Execute Jqueryui Online, Compile Jqueryui Online, Online jQueryUI Editor (jQueryUI (1.12)), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="7446339"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online jQueryUI Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var modename = "html";
var version = "jQueryUI (1.12)";
var opt = "new";
var projectid = "";
var projecttitle = "Online jQueryUI Editor";
var userid = 0;
var username = "root";
var ext = "htm";
</script>
