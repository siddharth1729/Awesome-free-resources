...
<head>
<meta charset="utf-8">
<title>Computer Organization - Tutorialspoint</title>    
<meta name="Description" content="Computer Organization - This video tutorial provides a complete understanding of the fundamental concepts of Computer Organization. The tutor starts with the very basics and gradually "/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/91/images/course_91_image.png" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;13:33:58 of High Quality Videos</div>
								<div class="item-link"><i class="fa fa-play-circle"></i>&nbsp;107 &nbsp;Lectures</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="91"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Computer Organization</h1>
								...
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
										...
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>This video tutorial provides a complete understanding of the fundamental concepts of Computer Organization. The tutor starts with the very basics and gradually moves on to cover a range of topics such as Instruction Sets, Computer Arithmetic, Process Unit Design, Memory System Design, Input-Output Design, Pipeline Design, and RISC. In addition, the tutor has solved a number of GATE problems related to Computer Organization to reinforce the concepts.</p><h1>Audience</h1><p>These video classes have been developed based on the latest GATE syllabus and will be useful for undergraduate students of Computer Science and Information Technology as well as those preparing for GATE exams. It will also be helpful for students in preparing them for their Engineering Syllabus.</p></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="509">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;">Computer Organization 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-509"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-509"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:00:56</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Computer Organization - Getting Started</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="N0pkNVZ6S2t6UlprazFLZTFvZHN5QT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=N0pkNVZ6S2t6UlprazFLZTFvZHN5QT09&cid=91/preview_video.php?vl=N0pkNVZ6S2t6UlprazFLZTFvZHN5QT09&cid=91" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:00:56</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="510">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;">Performance Measures 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-510"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-510"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:12:11</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Performance Measures on CPU</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Performance Measures GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="511">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;"> Instructions Set Architecture & Design 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-511"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-511"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">20 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:16:48</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Architectural Classification By M. J. Flynn</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Instruction Formats</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> 3 Address Instruction Format Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> 2 Address Instruction Format Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> 1 Address Instruction Format Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> 0 Address Instruction Format Example</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Instruction Format GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Instruction Format GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Micro-Instruction Formats</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:06</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Classifications of Addressing Modes</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Comparison Table-1 on Addressing Modes</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Auto Increment & Decrement Addressing Modes</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Comparison Table-2 on Addressing Modes</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Addressing Mode GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Addressing Mode GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Addressing Modes GATE Exercise 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Data Dependency With GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Data Dependency GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Machine Instructions GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Machine Instructions GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="513">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;"> Computer Arithmetic 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-513"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-513"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">18 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:38:19</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Arithmetic and Logic Operations GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:09</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Unsigned Number Representation</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="bjI3RkxWNWZXV2RHdERHZ2tCMnV0UT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=bjI3RkxWNWZXV2RHdERHZ2tCMnV0UT09&cid=91/preview_video.php?vl=bjI3RkxWNWZXV2RHdERHZ2tCMnV0UT09&cid=91" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Signed Number Representation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Number Representation With Problems and Issues</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Number Representation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Number Representation GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Number Representation In IEEE 754 Format</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:47</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Number Representation In IEEE 754 Format GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Arithmetic on Addition & Subtraction</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:10</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Arithmetic on Multiplication</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Floating Point Arithmetic on Division</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Carry Ripple Adder and Subtractor Circuits</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Carry Ripple Through Adder GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Multiplication Using Add-Shift Method</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:10:59</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Multiplication Using Array Multiplier</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Booth&#039;s Algorithm For Signed Multiplication</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Restoring Division Algorithm For Unsigned Integer</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:13:07</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Non Restoring Division Algorithm For Unsigned Integer</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="514">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;"> Processor Unit Design 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-514"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-514"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">10 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:15:16</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Register Sets and Categories</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="L04rcWY3ZmVPYjNzdjB3bFo2ZVlIUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=L04rcWY3ZmVPYjNzdjB3bFo2ZVlIUT09&cid=91/preview_video.php?vl=L04rcWY3ZmVPYjNzdjB3bFo2ZVlIUT09&cid=91" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction To Control Unit</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:33</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Micro-Programmed Control Unit Design</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Wilkes Design On Micro-Programmed Control Unit</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Microprogramming GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Microprogramming GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hardwired Control Circuit Design</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:59</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Control Circuit Design GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Bus Arbitration Techniques</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Data Path</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="516">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;">Memory System Design 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-516"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-516"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">32 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">04:19:42</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Read Write and Stack Push Pop</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> 2D And 2.5D Memory Chip Organization</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Allocation Algorithm</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Allocation GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Management GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Management GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Memory Management GATE Exercise 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:36</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Virtual Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Page Fault In Virtual Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> FIFO Page Replacement Algorithm GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:56</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Optimal Page Replacement Algorithm GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:05</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> LRU Page Replacement Algorithm GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Page Fault GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:19</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Page Replacement GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:07</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Page Replacement GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Page Replacement GATE Exercise 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction To Cache Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="WGJRSHFTdXlsU25ua3c0a1N4d3hkQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=WGJRSHFTdXlsU25ua3c0a1N4d3hkQT09&cid=91/preview_video.php?vl=WGJRSHFTdXlsU25ua3c0a1N4d3hkQT09&cid=91" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:07:57</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cache Memory Direct Mapping</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cache Mapping Fully Associative Mapping</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cache Mapping Set Block Associative Mapping</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cache Memory GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cache Memory GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk Scheduling GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk GATE Exercise 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:08:33</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk GATE Exercise 4</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction on Hamming Code</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:12:18</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hamming Code SEC Method</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hamming Code DED Method</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hamming Code GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="521">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;"> Input Output Design & Organization 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-521"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-521"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">15 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">01:43:46</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Bus Transmission</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Input & Output Using Handshake Signals</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Data Path With GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Input Output Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Input Output Kernel Subsystem</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction To Direct Memory Access (DMA)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:40</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Direct Memory Access (DMA)</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="bFZCblh0R21TTlZnWVBFUUFlaDJnZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=bFZCblh0R21TTlZnWVBFUUFlaDJnZz09&cid=91/preview_video.php?vl=bFZCblh0R21TTlZnWVBFUUFlaDJnZz09&cid=91" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Details On Direct Memory Access (DMA)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:45</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Bus Structures of Direct Memory Access (DMA)</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DMA GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> DMA GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> What Is Interrupts?</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Interrupt GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:21</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Interrupt GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:21</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> I/O Handling GATE Exercise</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="523">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;"> Pipeline Design Technique 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-523"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-523"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">7 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:47:40</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction To Pipeline Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:30</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Synchronous and Asynchronous Pipeline Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Instruction Pipeline Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Arithmetic Pipeline Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:08</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Pipeline Architecture GATE Exercise 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:06:45</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Pipeline Architecture GATE Exercise 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Pipeline Architecture GATE Exercise 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:05:21</span></div>
                                                      																<div class="clear"></div>
												...
												<li class="toc" data-sid="524">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#006ab4!important;line-height:10px!important;">Reduced Instruction Set Computers (RISC) 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-524"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-524"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:19:20</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> RISC And CISC Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Exercise On RISC Architecture</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
