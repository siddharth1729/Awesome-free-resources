...
<title>Online Lolcode Compiler - Online Lolcode Editor - Online Lolcode IDE - Lolcode Coding Online - Practice Lolcode Online - Execute Lolcode Online - Compile Lolcode Online - Run Lolcode Online</title>
<meta name="Description" content="Online Lolcode Compiler, Online Lolcode Editor, Online Lolcode IDE, Lolcode Coding Online, Practice Lolcode Online, Execute Lolcode Online, Compile Lolcode Online, Run Lolcode Online, Online Lolcode Interpreter, Execute LOLCODE Online (lci v0.10.5)"/>
<meta name="Keywords" content="Online Lolcode Compiler, Online Lolcode Editor, Online Lolcode IDE, Lolcode Coding Online, Practice Lolcode Online, Execute Lolcode Online, Compile Lolcode Online, Execute LOLCODE Online (lci v0.10.5), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute LOLCODE Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "lci main.lo";
var filename = "main.lo";
var mainfile = "main.lo";
var modename = "vbscript";
var version = "lci v0.10.5";
var opt = "new";
var projectid = "";
var projecttitle = "Execute LOLCODE Online";
var userid = 0;
var username = "root";
var ext = "lo";
</script>
