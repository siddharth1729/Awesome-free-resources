...
<title>Online Fantom Compiler - Online Fantom Editor - Online Fantom IDE - Fantom Coding Online - Practice Fantom Online - Execute Fantom Online - Compile Fantom Online - Run Fantom Online</title>
<meta name="Description" content="Online Fantom Compiler, Online Fantom Editor, Online Fantom IDE, Fantom Coding Online, Practice Fantom Online, Execute Fantom Online, Compile Fantom Online, Run Fantom Online, Online Fantom Interpreter, Execute Fantom Online (Fantom v1.0.66)"/>
<meta name="Keywords" content="Online Fantom Compiler, Online Fantom Editor, Online Fantom IDE, Fantom Coding Online, Practice Fantom Online, Execute Fantom Online, Compile Fantom Online, Execute Fantom Online (Fantom v1.0.66), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Fantom Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "fan main.fan";
var filename = "main.fan";
var mainfile = "main.fan";
var modename = "java";
var version = "Fantom v1.0.66";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Fantom Online";
var userid = 0;
var username = "root";
var ext = "fan";
</script>
