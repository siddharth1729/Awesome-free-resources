...
<title>Online Csharp Compiler - Online Csharp Editor - Online Csharp IDE - Csharp Coding Online - Practice Csharp Online - Execute Csharp Online - Compile Csharp Online - Run Csharp Online</title>
<meta name="Description" content="Online Csharp Compiler, Online Csharp Editor, Online Csharp IDE, Csharp Coding Online, Practice Csharp Online, Execute Csharp Online, Compile Csharp Online, Run Csharp Online, Online Csharp Interpreter, Compile and Execute C# Sharp Online (Mono v5.2.2)"/>
<meta name="Keywords" content="Online Csharp Compiler, Online Csharp Editor, Online Csharp IDE, Csharp Coding Online, Practice Csharp Online, Execute Csharp Online, Compile Csharp Online, Compile and Execute C# Sharp Online (Mono v5.2.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute C# Sharp Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "csharp";
var preview = 0;
var compile = "mcs *.cs -out:main.exe";
var execute = "mono main.exe";
var filename = "main.cs";
var mainfile = "main.cs";
var modename = "csharp";
var version = "Mono v5.2.2";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute C# Sharp Online";
var userid = 0;
var username = "root";
var ext = "cs";
</script>
