...
<title>Online C++0x Compiler - Online C++0x Editor - Online C++0x IDE - C++0x Coding Online - Practice C++0x Online - Execute C++0x Online - Compile C++0x Online - Run C++0x Online</title>
<meta name="Description" content="Online C++0x Compiler, Online C++0x Editor, Online C++0x IDE, C++0x Coding Online, Practice C++0x Online, Execute C++0x Online, Compile C++0x Online, Run C++0x Online, Online C++0x Interpreter, Compile and Execute C++0x Online (GNU GCC v7.1.1)"/>
<meta name="Keywords" content="Online C++0x Compiler, Online C++0x Editor, Online C++0x IDE, C++0x Coding Online, Practice C++0x Online, Execute C++0x Online, Compile C++0x Online, Compile and Execute C++0x Online (GNU GCC v7.1.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute C++0x Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "cpp0x";
var preview = 0;
var compile = "g++ -std=c++0x -o main *.cpp";
var execute = "main";
...
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute C++0x Online";
var userid = 0;
var username = "root";
var ext = "cpp";
</script>
