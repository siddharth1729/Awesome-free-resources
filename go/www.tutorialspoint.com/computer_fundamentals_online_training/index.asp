...
<head>
<meta charset="utf-8">
<title>Computer Fundamentals Online Training - Tutorialspoint</title>    
<meta name="Description" content="Computer Fundamentals Online Training - In this video tutorial we will discuss in detail about the different parts of computer that enable it to carry out its tasks efficiently and correctly. We will "/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/188/images/course_188_image.png" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;02:35:58 of High Quality Videos</div>
								<div class="item-link"><i class="fa fa-play-circle"></i>&nbsp;46 &nbsp;Lectures</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="188"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Computer Fundamentals Online Training</h1>
									<h2 class="course_header_sub">Simply Easy Learning</h2>
									<h3>Created by
									 									  
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/Shweta-55" title="View Profile Shweta"> <b>Shweta</b></a>,
								...
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
										...
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>In this video tutorial we will discuss in detail about the different parts of computer that enable it to carry out its tasks efficiently and correctly. We will also discuss about microprocessors, the brain of computers, which actually do all the assigned tasks.</p><h1>Audience</h1><p>This video tutorial has been mapped to the Class XI CBSE syllabus for Computer Science. However, anyone who wants to understand the basic concepts of what a computer is and how it functions will benefit from it.</p></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="1020">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Computer Overview 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-1020"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-1020"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:11:31</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction to Computers</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="RXNlQnpYVGY3bkdtU1Rubk9vb3pnUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=RXNlQnpYVGY3bkdtU1Rubk9vb3pnUT09&cid=188/preview_video.php?vl=RXNlQnpYVGY3bkdtU1Rubk9vb3pnUT09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Features of Computer</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="RTBxOCtOa3FOWFovdG1nMHVnck15QT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=RTBxOCtOa3FOWFovdG1nMHVnck15QT09&cid=188/preview_video.php?vl=RTBxOCtOa3FOWFovdG1nMHVnck15QT09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Computer Booting</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="bi91UXJHWjZPYkQ1cXJTaVkyem1ZZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=bi91UXJHWjZPYkQ1cXJTaVkyem1ZZz09&cid=188/preview_video.php?vl=bi91UXJHWjZPYkQ1cXJTaVkyem1ZZz09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
												...
												<li class="toc" data-sid="1022">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Classification of Computers 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-1022"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-1022"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:08:32</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Classification of Computers</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="OWl4bEE3bDdqYURSRHRra3l3Y2V4QT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=OWl4bEE3bDdqYURSRHRra3l3Y2V4QT09&cid=188/preview_video.php?vl=OWl4bEE3bDdqYURSRHRra3l3Y2V4QT09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Computer Servers</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1023">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Classification of System 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1023"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1023"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:07:00</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Software Concepts</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> System Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Application Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:07</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="1027">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">System Software 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1027"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1027"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:13:25</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Operating System</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="TEo4L3NIYWZKTWhyVWVKYU1zSUh5QT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=TEo4L3NIYWZKTWhyVWVKYU1zSUh5QT09&cid=188/preview_video.php?vl=TEo4L3NIYWZKTWhyVWVKYU1zSUh5QT09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Assembler Overview</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Interpreter Overview</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Compiler Overview</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1030">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Functions Of Operating System 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1030"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1030"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">5 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:17:19</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Functions of Operating System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Processor Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                   ...
                                                   <div class="col-md-2 padding">
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> File Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Device Management</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1032">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Operating Systems 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1032"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1032"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:10:37</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Types of Operating Systems</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:46</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Popular Operating Systems</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Mobile Operating Systems</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1035">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Utility Software 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1035"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1035"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:10:10</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Anti-Virus</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="L3hPM2Z6eGxpRExmN3hKOC9KelBNUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=L3hPM2Z6eGxpRExmN3hKOC9KelBNUT09&cid=188/preview_video.php?vl=L3hPM2Z6eGxpRExmN3hKOC9KelBNUT09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> File Management Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Disk Management Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1039">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Disk Management Software 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1039"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1039"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:05:21</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Open Source Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Proprietary Software</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1040">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Office Tools 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1040"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1040"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:04:19</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Office Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1043">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Domain Specific Tools 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1043"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1043"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:03:37</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Domain Specific Tools</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1044">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Number System 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1044"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1044"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">6 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:17:41</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Number System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Number System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:43</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Octal Number System</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Hexadecimal Number System</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="MW9lTUlMTW50TEh5a0pPUDlYaThsZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=MW9lTUlMTW50TEh5a0pPUDlYaThsZz09&cid=188/preview_video.php?vl=MW9lTUlMTW50TEh5a0pPUDlYaThsZz09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Number System Relationship</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Coding For Information Exchange</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1048">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Number System Conversion 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1048"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1048"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:08:27</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Decimal Number Conversion</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Binary Number Conversion</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1050">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Microprocessor Concepts 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1050"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1050"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:09:34</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Microprocessor Concepts</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:22</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Microprocessors Characteristics</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Microprocessor Components</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1052">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Evolution of Microprocessors 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1052"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1052"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:07:19</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Evolution of Microprocessors</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:22</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Categories of Microprocessors</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1053">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Primary Memory 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1053"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1053"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:07:55</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Primary Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="bVZQK0ZVTTRHbDZDR3F1RkdacXlJZz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=bVZQK0ZVTTRHbDZDR3F1RkdacXlJZz09&cid=188/preview_video.php?vl=bVZQK0ZVTTRHbDZDR3F1RkdacXlJZz09&cid=188" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:03</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Types of Primary Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1055">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;">Secondary Memory 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1055"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1055"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:06:55</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Secondary Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:01:26</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Types of Secondary Memory</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="1057">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#0c6ac4!important;line-height:10px!important;"> Input - Output Ports 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-1057"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-1057"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:06:16</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Input - Output Ports</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Types of Ports</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
							...
							<div class="panel large-panel">
									...
									<img src="https://www.tutorialspoint.com/assets/profiles/7499/profile/200_79482-1511173311.png" title="Shweta"/>
									<h4><a href='https://www.tutorialspoint.com/videotutorials/profile/Shweta-55' target='_blank' title='View Shweta Profile '>Shweta</a></h4>
									<h5></h5>
									<p>Shweta is a postgraduate in Computer Management from University of Pune. She has worked as Instructional Designer and Content Creator for companies like NIIT and Whizlabs, creating Computer Science courses from KG to PG. She also taught Computer Science at DPS, Bokaro, for 4 years. She is an avid blogger, author, editor and course content creator.</p>             
								</div>
