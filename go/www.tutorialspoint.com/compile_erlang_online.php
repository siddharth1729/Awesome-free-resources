...
<title>Online Erlang Compiler - Online Erlang Editor - Online Erlang IDE - Erlang Coding Online - Practice Erlang Online - Execute Erlang Online - Compile Erlang Online - Run Erlang Online</title>
<meta name="Description" content="Online Erlang Compiler, Online Erlang Editor, Online Erlang IDE, Erlang Coding Online, Practice Erlang Online, Execute Erlang Online, Compile Erlang Online, Run Erlang Online, Online Erlang Interpreter, Compile and Execute Erlang Online (Erlang 19.3.6)"/>
<meta name="Keywords" content="Online Erlang Compiler, Online Erlang Editor, Online Erlang IDE, Erlang Coding Online, Practice Erlang Online, Execute Erlang Online, Compile Erlang Online, Compile and Execute Erlang Online (Erlang 19.3.6), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Erlang Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "erlang";
var preview = 0;
var compile = "erlc *.erl";
var execute = "erl -noshell -s helloworld start -s init stop";
var filename = "helloworld.erl";
var mainfile = "helloworld.erl";
var modename = "erlang";
var version = "Erlang 19.3.6";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Erlang Online";
var userid = 0;
var username = "root";
var ext = "erl";
</script>
