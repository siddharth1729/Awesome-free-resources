...
<title>Online Scala Compiler - Online Scala Editor - Online Scala IDE - Scala Coding Online - Practice Scala Online - Execute Scala Online - Compile Scala Online - Run Scala Online</title>
<meta name="Description" content="Online Scala Compiler, Online Scala Editor, Online Scala IDE, Scala Coding Online, Practice Scala Online, Execute Scala Online, Compile Scala Online, Run Scala Online, Online Scala Interpreter, Compile and Execute Scala Online (Scala v2.10.6)"/>
<meta name="Keywords" content="Online Scala Compiler, Online Scala Editor, Online Scala IDE, Scala Coding Online, Practice Scala Online, Execute Scala Online, Compile Scala Online, Compile and Execute Scala Online (Scala v2.10.6), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Scala Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "scala";
var preview = 0;
var compile = "scalac *.scala";
var execute = "scala HelloWorld";
var filename = "HelloWorld.scala";
var mainfile = "HelloWorld.scala";
var modename = "scala";
var version = "Scala v2.10.6";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Scala Online";
var userid = 0;
var username = "root";
var ext = "scala";
</script>
