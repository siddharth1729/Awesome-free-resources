...
<title>Online Factor Compiler - Online Factor Editor - Online Factor IDE - Factor Coding Online - Practice Factor Online - Execute Factor Online - Compile Factor Online - Run Factor Online</title>
<meta name="Description" content="Online Factor Compiler, Online Factor Editor, Online Factor IDE, Factor Coding Online, Practice Factor Online, Execute Factor Online, Compile Factor Online, Run Factor Online, Online Factor Interpreter, Execute Factor Online (Factor v8.21)"/>
<meta name="Keywords" content="Online Factor Compiler, Online Factor Editor, Online Factor IDE, Factor Coding Online, Practice Factor Online, Execute Factor Online, Compile Factor Online, Execute Factor Online (Factor v8.21), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Factor Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "factor main.factor";
var filename = "main.factor";
var mainfile = "main.factor";
var modename = "c_cpp";
var version = "Factor v8.21";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Factor Online";
var userid = 0;
var username = "root";
var ext = "factor";
</script>
