...
<title>Online Basic Compiler - Online Basic Editor - Online Basic IDE - Basic Coding Online - Practice Basic Online - Execute Basic Online - Compile Basic Online - Run Basic Online</title>
<meta name="Description" content="Online Basic Compiler, Online Basic Editor, Online Basic IDE, Basic Coding Online, Practice Basic Online, Execute Basic Online, Compile Basic Online, Run Basic Online, Online Basic Interpreter, Execute Ya Basic Online (Yabasic v2.78.1)"/>
<meta name="Keywords" content="Online Basic Compiler, Online Basic Editor, Online Basic IDE, Basic Coding Online, Practice Basic Online, Execute Basic Online, Compile Basic Online, Execute Ya Basic Online (Yabasic v2.78.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Ya Basic Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "yabasic main.bas";
var filename = "main.bas";
var mainfile = "main.bas";
var modename = "vbscript";
var version = "Yabasic v2.78.1";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Ya Basic Online";
var userid = 0;
var username = "root";
var ext = "bas";
</script>
