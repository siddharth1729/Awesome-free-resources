...
<title>Online Bootstrap Compiler - Online Bootstrap Editor - Online Bootstrap IDE - Bootstrap Coding Online - Practice Bootstrap Online - Execute Bootstrap Online - Compile Bootstrap Online - Run Bootstrap Online</title>
<meta name="Description" content="Online Bootstrap Compiler, Online Bootstrap Editor, Online Bootstrap IDE, Bootstrap Coding Online, Practice Bootstrap Online, Execute Bootstrap Online, Compile Bootstrap Online, Run Bootstrap Online, Online Bootstrap Interpreter, Online Bootstrap Editor (Bootstrap (3.3.1))"/>
<meta name="Keywords" content="Online Bootstrap Compiler, Online Bootstrap Editor, Online Bootstrap IDE, Bootstrap Coding Online, Practice Bootstrap Online, Execute Bootstrap Online, Compile Bootstrap Online, Online Bootstrap Editor (Bootstrap (3.3.1)), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="4865172"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online Bootstrap Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var modename = "html";
var version = "Bootstrap (3.3.1)";
var opt = "new";
var projectid = "";
var projecttitle = "Online Bootstrap Editor";
var userid = 0;
var username = "root";
var ext = "htm";
</script>
