...
<title>Online Tcl Compiler - Online Tcl Editor - Online Tcl IDE - Tcl Coding Online - Practice Tcl Online - Execute Tcl Online - Compile Tcl Online - Run Tcl Online</title>
<meta name="Description" content="Online Tcl Compiler, Online Tcl Editor, Online Tcl IDE, Tcl Coding Online, Practice Tcl Online, Execute Tcl Online, Compile Tcl Online, Run Tcl Online, Online Tcl Interpreter, Execute Tcl Online (Tcl v8.6.6)"/>
<meta name="Keywords" content="Online Tcl Compiler, Online Tcl Editor, Online Tcl IDE, Tcl Coding Online, Practice Tcl Online, Execute Tcl Online, Compile Tcl Online, Execute Tcl Online (Tcl v8.6.6), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Tcl Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "tclsh main.tcl";
var filename = "main.tcl";
var mainfile = "main.tcl";
var modename = "tcl";
var version = "Tcl v8.6.6";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Tcl Online";
var userid = 0;
var username = "root";
var ext = "tcl";
</script>
