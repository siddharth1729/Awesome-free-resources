...
<title>Online Malbolge Compiler - Online Malbolge Editor - Online Malbolge IDE - Malbolge Coding Online - Practice Malbolge Online - Execute Malbolge Online - Compile Malbolge Online - Run Malbolge Online</title>
<meta name="Description" content="Online Malbolge Compiler, Online Malbolge Editor, Online Malbolge IDE, Malbolge Coding Online, Practice Malbolge Online, Execute Malbolge Online, Compile Malbolge Online, Run Malbolge Online, Online Malbolge Interpreter, Execute Malbolge Online (Malbolge)"/>
<meta name="Keywords" content="Online Malbolge Compiler, Online Malbolge Editor, Online Malbolge IDE, Malbolge Coding Online, Practice Malbolge Online, Execute Malbolge Online, Compile Malbolge Online, Execute Malbolge Online (Malbolge), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Malbolge Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "malbolge main.mal";
var filename = "main.mal";
var mainfile = "main.mal";
var modename = "text";
var version = "Malbolge";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Malbolge Online";
var userid = 0;
var username = "root";
var ext = "mal";
</script>
