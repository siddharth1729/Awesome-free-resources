...
<title>Online Rubydb Compiler - Online Rubydb Editor - Online Rubydb IDE - Rubydb Coding Online - Practice Rubydb Online - Execute Rubydb Online - Compile Rubydb Online - Run Rubydb Online</title>
<meta name="Description" content="Online Rubydb Compiler, Online Rubydb Editor, Online Rubydb IDE, Rubydb Coding Online, Practice Rubydb Online, Execute Rubydb Online, Compile Rubydb Online, Run Rubydb Online, Online Rubydb Interpreter, Execute Ruby MySQL Online (Ruby v2.4.1)"/>
<meta name="Keywords" content="Online Rubydb Compiler, Online Rubydb Editor, Online Rubydb IDE, Rubydb Coding Online, Practice Rubydb Online, Execute Rubydb Online, Compile Rubydb Online, Execute Ruby MySQL Online (Ruby v2.4.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Ruby MySQL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "ruby main.rb";
var filename = "main.rb";
var mainfile = "main.rb";
var modename = "ruby";
var version = "Ruby v2.4.1";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Ruby MySQL Online";
var userid = 0;
var username = "root";
var ext = "rb";
</script>
