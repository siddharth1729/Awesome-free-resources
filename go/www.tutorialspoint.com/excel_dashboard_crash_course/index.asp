...
<head>
<meta charset="utf-8">
<title>Excel Dashboard Crash Course - Tutorialspoint</title>    
<meta name="Description" content="Excel Dashboard Crash Course - Dashboard help user visualizes complex scenarios and problem better. Manager with the help of Advanced Excel dashboard can make better business decisions.Our co"/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/589/images/course_589_image.jpg" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;03:54:16 of High Quality Videos</div>
								<div class="item-link"><i class="fa fa-play-circle"></i>&nbsp;63 &nbsp;Lectures</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="589"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Excel Dashboard Crash Course</h1>
									<h2 class="course_header_sub">Steps to Create Advanced Excel Dashboard for Data Analytics with Visual using Excel Tools, Functions and Excel Macros</h2>
									<h3>Created by
									 ...
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/yodalearning" title="View Profile Yodalearning"> <b>Yodalearning</b></a>,
									 									  Last Updated <a href="javascript:void(0);"><b>24-Oct-2019</b></a>, Language:<a href="javascript:void(0);"><b>English</b></a></h3>
								</div>
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
									   										<h1>What Will I Get ?</h1>
										<ul>
																						<li>Analyze data and create reports in a fraction of the time of spreadsheets</li>  
																						<li>Create new powerful calculations, KPIs and Key Metrics</li>  
																						<li>Plot data on Map in Advanced Excel Dashboard</li>  
																						<li>Learn 3 types of Dashboards in this course</li>  
																						<li>Learn to make Excel Dashboard using Pivot tables</li>  
																						<li>Learn to create Excel Dashboard using Functions</li>  
																						<li>Learn to create Excel Dashboard using Macros and Functions</li>  
																						<li>Get Conclusion of all 3 Excel dashboards</li>  
																						<li></li>  
																					</ul>
                              <div class="clear"></div>  
										...
										<ul>
																						...
																						<li>Basic understanding of Excel because We&#039;ll take you to the advanced level in this Excel Dashboard crash CourseCourse</li> 
																						<li></li> 
																					</ul> 
																						 
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>Dashboard help user <strong>visualizes complex scenarios and problem better.</strong> Manager with the help of Advanced Excel dashboard can make better business decisions.</p><p>Our course is meant for professional working at <strong>different levels of careers</strong>, i.e., From MIS executive to Data Analyst.</p><p>MS Excel made it easy to make Dashboards for any Analytics. Business user can easily analyze data to create powerful reports and dashboards in a fraction of the time of traditional spreadsheets.</p><p><strong>In this course, you&#39;ll learn to make dashboard in Excel in different ways:</strong></p><h4>Dashboard using Pivot Table like Multiple Pivot, Interlinked Pivot, Slicer buttons to control charts, Advanced Charts, etc.</h4><ul><li><strong>Text Function</strong> in Excel</li><li><strong>Naming the dynamic data</strong> and the using it in function</li><li>Create Chart for <strong>comparison</strong> from the Pivot table</li><li>Create <strong>Trend line</strong> from the Pivot table</li><li>Creating <strong>Pie Chart from Slab Report </strong>from Pivot table</li><li>Inserting <strong>Slicer using Chart</strong> & Customize Slicer Setting</li><li>more..</li></ul><h4>Dashboard using Excel Functions:</h4><ul><li><strong>Importing Data</strong> from the Internet</li><li>Converting Line Item into a <strong>Currency Table </strong></li><li>Calculation of Currency using <strong>INDEX and MATCH</strong> </li><li><strong>AverageIF </strong>for calculating Country Wise Salary</li><li>Dynamic <strong>Dropdown </strong></li><li>List <strong>longitude and latitude</strong> with plotting data on dashboard</li><li>Using <strong>REPT Function</strong> based on the percentage calculation</li><li>Advanced INDEX and MATCH with multiple references</li><li><strong>Insert World Map</strong> into the chart</li><li><strong>Plotting Data on Map</strong> Chart and Controlling Map Preview from drop-down</li><li>Preparing the base by <strong>removing duplicate </strong>for Dashboard</li><li>more..</li></ul><h4>Dashboard using Excel Macros & Functions</h4><ul><li>Implementation of <strong>OFFSET for dynamic data</strong></li><li>Using<strong> macro to update pivot table</strong> based on the Job Type</li><li>Preparing data for <strong>Spiderweb chart</strong> and change the graph setting</li><li>Use of <strong>Array functions</strong> like MAXIF and MINIF with single and multiple parameters</li><li>Creating <strong>Name Range</strong> using shortcut</li><li>more..</li></ul><p>This course is for all business users who want to learn how to create management reports, analyze data and create interactive dashboards using Excel 2010 and later versions.</p><h1>Benefits Of Excel Dashboard Crash Course</h1><ul><li>It Provides an Overview OF your Problem</li><li>You get to avail total Visibility into your Business</li><li>Excel Dashboards provide extreme flexibility</li><li>Saves more time at Work</li><li>Increased Profits</li><li>You’ll get Improved Results with interactive Dashboards</li></ul><p>If you have read this far, <strong>next action is JOINING this course</strong>. Invest 4 hrs. for the benefit of lifetime Ninja status on Advanced Excel Dashboard Crash Course.</p><h1>Who this course is for:</h1><ul><li>People who analyze data and create new insight</li><li>People who do reporting and create dashboards</li><li>Professionals working with large amount of Data</li></ul></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="2522">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">Introduction 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-2522"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-2522"></i> 
														</span>
													...
													<ul class="submenu ">
															...
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction to Dashboard Course</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="L1phbDhTaTAzZ0o2QlduYXVwL0xVUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=L1phbDhTaTAzZ0o2QlduYXVwL0xVUT09&cid=589/preview_video.php?vl=L1phbDhTaTAzZ0o2QlduYXVwL0xVUT09&cid=589" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction to 1st Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="czIvalY4UHpHZUUrVmpzUi8xdjlDQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=czIvalY4UHpHZUUrVmpzUi8xdjlDQT09&cid=589/preview_video.php?vl=czIvalY4UHpHZUUrVmpzUi8xdjlDQT09&cid=589" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
												...
												<li class="toc" data-sid="2524">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">Working Files 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-2524"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-2524"></i> 
														</span>
														<span class="lec-items">
													...
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> Downloadable Content For Practice</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
												...
												<li class="toc" data-sid="2525">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">1st Dashboard using Pivot		 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-2525"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-2525"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">12 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:53:58</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Understanding the Data</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Text Function</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Data Create Table</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Naming the dynamic data and using it in the function</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Preparing 1st Pivot & updating data</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Classic View & Filling blank with zero in Pivot</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create Chart for comparison from the Pivot</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create Trend Line from the Pivot</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Pie Chart from Slab Report from Pivot</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Preparing Framework for Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Inserting Slicer using Chart</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Customize Slicer Settings</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="2528">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">2nd Dashboard using Functions		 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-2528"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-2528"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">34 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">02:03:30</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Brief on 2nd Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Importing Data from the Internet</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Converting Line Item into a Currency Table</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Calculation of Currency using INDEX & MATCH</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Slabs using Vlookup True Parameter</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Qtrs based on Financial or Calendar Selection</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Preparing the base by removing duplicates for Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> AverageIF for calculating Country Wise Salary</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Substituting ERROR with zero using IFERROR</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction to Function INDIRECT Part 1 & 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Function INDIRECT to Retrieve AverageIF from relevant sheet</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Function CountIF with INDIRECT to calculate No. of Emp</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Calculating Contribution Country wise No Of Emp</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using NameRange to simplify calculation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using NameRange with formula in 2nd Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Introduction to Offset Function</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Offset Function in Excel</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Offset Function in Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Use of MINIF in Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Use of MAXIF in Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Average to get Designation Wise Experience result</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using MAXIF with multiple conditions</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using MINIF with multiple conditions</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic Dropdown List</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Longitude and latitude with plotting data on dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:08</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using REPT Function based on the percentage calculation</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:02:41</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Activation of Developer Tab and creating Scroll Bar</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Inserting Trend chart based on data</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Advance INDEX and MATCH with multiple references</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Inserting Spark Line</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Insert World Map into the chart</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Plotting Data on Map Chart</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Controlling Map Preview from dropdown</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Summarizing 2nd Dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="2614">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">3rd Dashboard using Functions $ Macros 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-2614"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-2614"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">13 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:49:09</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Brief on 3rd Dashboards</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Implementation of OFFSET for dynamic data</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:45</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Trend Chart from 2 Pivot Table</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:03:46</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Modifying the Chart Settings for better view</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Macro recording for Trend Chart 01</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using macro to update pivot based on the Job Type</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Triggering macro with any change in sheets</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Creating Name Range using shortcut</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create chart to represent multiple parameters effectively 01</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create chart to represent multiple parameters effectively 02</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Preparing data for Spiderweb chart and change the graph setting</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:04:39</span></div>
                                                      																<div class="clear"></div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using macro to Hide and Unhide working sheets</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Inserting Trendline and formatting for better view</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="2644">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#1E6C41!important;line-height:10px!important;">Conclusion		 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-2644"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-2644"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:03:25</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Conclusion of all 3 dashboard</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
							...
							<div class="panel large-panel">
								...
								<h3>More Courses from <a href="https://www.tutorialspoint.com/videotutorials/profile/yodalearning" target="_blank" title="View Yodalearning Profile">Yodalearning </a></h3><div>								<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse599">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/advanced_excel_crash_course/index.asp" title="Advanced Excel Crash Course">
													<div class="card-content" title="Advanced Excel Crash Course"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/599/images/course_599_image.jpg?t=1585071294" alt="Advanced Excel Crash Course Image" />
														<div class="card-title" title="Advanced Excel Crash Course">Advanced Excel Crash Course</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													...
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='599'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
											...
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/knime_crash_course/index.asp" title="KNIME Crash Course">
													<div class="card-content" title="KNIME Crash Course"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/532/images/course_532_image.jpg?t=1585071294" alt="KNIME Crash Course Image" />
