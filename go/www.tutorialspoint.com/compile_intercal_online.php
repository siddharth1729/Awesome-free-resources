...
<title>Online Intercal Compiler - Online Intercal Editor - Online Intercal IDE - Intercal Coding Online - Practice Intercal Online - Execute Intercal Online - Compile Intercal Online - Run Intercal Online</title>
<meta name="Description" content="Online Intercal Compiler, Online Intercal Editor, Online Intercal IDE, Intercal Coding Online, Practice Intercal Online, Execute Intercal Online, Compile Intercal Online, Run Intercal Online, Online Intercal Interpreter, Compile and Execute INTERCAL Online (Intercal v0.30)"/>
<meta name="Keywords" content="Online Intercal Compiler, Online Intercal Editor, Online Intercal IDE, Intercal Coding Online, Practice Intercal Online, Execute Intercal Online, Compile Intercal Online, Compile and Execute INTERCAL Online (Intercal v0.30), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute INTERCAL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var mainfile = "main.i";
var modename = "sh";
var version = "Intercal v0.30";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute INTERCAL Online";
var userid = 0;
var username = "root";
var ext = "i";
</script>
