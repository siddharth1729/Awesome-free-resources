...
<head>
<meta charset="utf-8">
<title>Python Full Stack Web Development with Google Cloud Service - Tutorialspoint</title>    
<meta name="Description" content="Python Full Stack Web Development with Google Cloud Service - You look at social platforms like facebook, twitter, have you ever imagined yourself being able to create one for yourself? Social web application is getting ve"/>
			...
			<div class="content-wrapper">
				<div class="desktop large">
					...
					<div class="col-md-4 padding">
						<div class="courseimg panel sticky large-panel"> 
							<div class="course_header">
								<div class="course_img"><img src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/1082/images/course_1082_image.jpg" /></div>
							</div>    
							<div class="tp-includes">
								<div class="item-head"><i class="fa fa-paperclip"></i> Subscription Includes</div>
								<div class="item-link"><i class="fa fa-clock"></i>&nbsp;06:12:20 of High Quality Videos</div>
								<div class="item-link"><i class="fa fa-play-circle"></i>&nbsp;35 &nbsp;Lectures</div>
                    ...
                    <div class="col-md-12 col-sm-12 padding">
								                           <button class="btn btn-success" title="Add to Cart"><a href="javascript:void(0);" class="add-to-cart-form"><i class="fa fa-shopping-cart"></i> Add To Cart<input type = "hidden" name="couser_id" id="course_id" value="1082"></a></button>
						...
						<div class="content-body">				
							<div class="">
								...
								<div class="background">
									<h1 class="course_header_title">Python Full Stack Web Development with Google Cloud Service</h1>
									<h2 class="course_header_sub">Using Python Flask framework with MongoDB, Google Cloud Storage, Google Cloud API to build a social web application</h2>
									<h3>Created by
									 									  
									 <a href="https://www.tutorialspoint.com/videotutorials/profile/jack_chan" title="View Profile Jack Chan"> <b>Jack Chan</b></a>,
									 									  Last Updated <a href="javascript:void(0);"><b>09-Mar-2020</b></a>, Language:<a href="javascript:void(0);"><b>English</b></a></h3>
								</div>
								<div class="padding tp-pre-tags">
									<div class="tp-widget">                
									   										<h1>What Will I Get ?</h1>
										<ul>
																						<li>Built a real life party web application using the Python Flask framework</li>  
																						<li>Using Mongo DB to store data</li>  
																						<li>Using Google Cloud Storage, API</li>  
																					</ul>
                              <div class="clear"></div>  
										           
									  										<h1>Requirements</h1>
										<ul>
																						<li>You need to have a basic understanding about Python</li> 
																						<li>You are recommended to take our beginner course &quot;Learn Python in a Day&quot;</li> 
																					</ul> 
																						 
										<div class="clear"></div>  
                              <h1>Description</h1>
									   <p><p>You look at social platforms like facebook, twitter, have you ever imagined yourself being able to create one for yourself? Social web application is getting very popular, but to your surprise, it is not hard to build one. Have you ever imagined telling your friends that you can build a full stack web application from scratch all by yourself? You can learn it in this course!</p><p>Programming is one of the very important skills that people value a lot in this era. Not only it can help you get a well-paid software engineer job, but it can also train your brain to think in a logically manner. We are sure you agree with that but you are not sure where and how to start. You may already know some basics about programming, which is good, but you may think that is another level to build a useful application by yourself. Don&#39;t worry, in this course, we will guide you how to create your first python full stack web application step by step. You may become the next Jeff Bazos or Mark Zuckerburg!</p><h1>What exactly will you learn?</h1><p>This course has a goal, which is to show you how you can build real life full stack web application using python.</p><p>Unlike other programming courses which spent a lot of time on covering the syntax and logic, this course focus on the practical usage of the language. We assume you have basic understanding about the programming language (Python), we then teach you how you can build this social party web application from scratch.</p><p>This course also cover a lot of latest technology like Mongo DB, Google cloud storage, Google Location API etc. Since we are showing you how to build the online web application step by step, you will see us using the free online IDE CodeAnywhere. Your application is runnable in the free server by provided by CodeAnywhere.</p><p>You can also take this chance to revise important programming concept in Python.</p><p><strong>Features of the party go application that you will write</strong></p><ol><li><p>Online web application with very nice layout</p></li><li><p>Allow users to create their own accounts and edit user profiles</p></li><li><p>Users are allowed to upload profiles pictures, party pictures</p></li><li><p>Create parties with customized information like location, date etc.</p></li><li><p>Data are stored in online document based database (Mongo DB)</p></li><li><p>User profile pictures, party pictures are stored using Google cloud storage</p></li></ol><p>Apart from the above, we incorporate the latest programming concept in the course as well. I hope with this little challenges, you can learn better. And if you come across any questions during the course, feel free to raise it. We are here to make sure you enjoy your learning process.</p><h1>What is Python?</h1><p>Python is a simple, intuitive, yet powerful programming language. It is an high-level programming language invented back in 1991. It is a go-to language for beginners because it is so easy and expressive. You can often express concepts with very few lines of code. That&#39;s why we choose Python as the programming language for this course!</p><p>However, don&#39;t have a misunderstanding that Python is only for beginner. It is used in many areas including data analysis, finance, scientific research, artificial intelligence etc. Python is a very powerful programming language and is well supported the community. There are lots of useful packages like Numpy, Scipy etc. It is a programming language that supports multiple programming paradigms like procedural, functional, object-oriented etc. </p><p>In a nutshell, if you can only learn one programming language, Python is your choice! And if you are a beginner and you want to grab the basics before taking this course, we recommend you to enroll our python beginner course - Learn Python in a Day. You can find the course under our profile.</p><h1>What is Flask?</h1><p>Flask is a micro web framework written in Python. It is classified as a microframework because it does not require particular tools or libraries. It supports extensions that can add application features and making the web applications built on Flask more powerful. Extensions are updated far more regularly than the core Flask program. In this course, we will cover Flask as well as other necessary extensions that are required to build this production grade party web platform. Flask is commonly used with MongoDB (which we will cover in this course as well), allowing it more control over databases and history.</p><h1>Who are the instructors?</h1><p>Jack comes from a software engineering background. He has built sophisticated systems for top tier investment banks. You can understand more about the instructor in their Udemy profile. </p><p><strong>Instructor: Jack Chan</strong></p><p><strong>Money back guaranteed!</strong></p><p>We are so confident about our course. We are so sure that you will enjoy the course as well. Therefore we provide money back guaranteed. After you have enrolled the course and if you don&#39;t like it, you can have your money back! It is unconditional, Udemy backed, 30 days money-back guarantee so you can try this course risk free!</p><h1>Who this course is for:</h1><ul><li>You are interested to create a web application</li><li>You are interested in web design</li><li>You are interested to understand document based database, e.g. Mongo DB</li><li>You are interested in cloud services</li></ul></p>
									   <div class="clear"></div>   
									</div>               
									...
									<div class="main-scroll">              
										...
										<div class="scroller" style="width:100%!important;overflow:auto;">
											<ul class="nav left-menu" style="overflow-x:hidden;width:100%!important;"> 
												...
												<li class="toc" data-sid="5455">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Learning Resources 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-5455"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-5455"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:01:24</span>
														</span>
													</a>   
													<ul class="submenu ">
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Getting the tools and additional learning resources needed</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="SlhZc2NDK2V5clI4N3NyTkV2Z1hDdz09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=SlhZc2NDK2V5clI4N3NyTkV2Z1hDdz09&cid=1082/preview_video.php?vl=SlhZc2NDK2V5clI4N3NyTkV2Z1hDdz09&cid=1082" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
												...
												<li class="toc" data-sid="5456">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Introduction 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:none" id="plus-show-5456"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:block" id ="plus-hide-5456"></i> 
														</span>
														<span class="lec-items">
                                                   ...
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="VXY1aXFJa2xaZSswS2VIb0toUUVQQT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=VXY1aXFJa2xaZSswS2VIb0toUUVQQT09&cid=1082/preview_video.php?vl=VXY1aXFJa2xaZSswS2VIb0toUUVQQT09&cid=1082" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Setting up Code Anywhere environment</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="akdYczIyb2w1UEtJTjM2b0tBY2lRUT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=akdYczIyb2w1UEtJTjM2b0tBY2lRUT09&cid=1082/preview_video.php?vl=akdYczIyb2w1UEtJTjM2b0tBY2lRUT09&cid=1082" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Installing the virtual environment and Flask framework</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" style="display:block">
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> The first Hello World application with Flask</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5457">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">The basics - Flask, MongoDB 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5457"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5457"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:24:00</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using Flask blueprints</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Setting up MongoDB</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Setting up User Models</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Additional lesson: Creating the database to Mongo DB Atlas</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5458">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Build forms - Jinja template, WTForms 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5458"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5458"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:41:53</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Building registration form - Jinja template</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Navigation bar</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Using WTForms</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:18:53</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Saving users&#039; information in Mongo DB</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5459">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Authentication 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5459"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5459"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:36:34</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> User login/logout</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Verified if the user has logged in</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:46</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Dynamic navigation bar</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5460">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">User profile management 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5460"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5460"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
													...
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Update user record</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:22:01</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5461">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Saving images in cloud 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5461"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5461"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">2 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:31:17</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Google cloud for pictures 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:11:15</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Google cloud for pictures 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:20:02</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5462">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Change Password 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5462"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5462"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:16:11</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Change Password</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:16:11</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5463">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">User public profile 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5463"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5463"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:09:48</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Setup user public profile</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5464">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Create new party 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5464"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5464"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:47:20</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create party part 1</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:24:23</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create party part 2</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:14:15</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Create party part 3</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5465">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Edit / Cancel / Display Party 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5465"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5465"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:56:12</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Edit Party</p></div>
                                                   <div class="col-md-2 padding">
                                                																	<input type="hidden" name="P_l_id" value="VzJyRi9JMnJJbC8vSFNDZllmUHo2UT09">
																	<span class='Preview_btn preview_video' data-href="https://www.tutorialspoint.com/videotutorials/preview_video.php?vl=VzJyRi9JMnJJbC8vSFNDZllmUHo2UT09&cid=1082/preview_video.php?vl=VzJyRi9JMnJJbC8vSFNDZllmUHo2UT09&cid=1082" title=""><b><i class="fa fa-video"></i> Preview</b></span>
																	<div class="clear"></div>
																	                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:19:06</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Cancel party</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Display party</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:22:37</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5466">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Join / Leave party 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5466"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5466"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">1 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:08:22</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Join / Leave party</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
												...
												<li class="toc" data-sid="5467">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Manage Parties 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5467"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5467"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">3 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:51:45</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Manage Party</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:17:50</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Pagination</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:09:50</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Explore and search for parties</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="col-md-1 padding"><span>00:24:05</span></div>
                                                      																<div class="clear"></div>
															</div>
														</li>
												...
												<li class="toc" data-sid="5468">
													<a href="javascript:void(0);" class="clsSection" style="background-color:#ea5756!important;line-height:10px!important;">Miscellaneous 
														<span class="toc-options">
															<i class="fa fa-plus-circle plus-hide" style="display:block" id="plus-show-5468"></i> 
															<i class="fa fa-minus-circle plus-show" style="display:none" id ="plus-hide-5468"></i> 
														</span>
														<span class="lec-items">
															<span style="padding-right:18px;">4 Lectures</span>
															<span style="width:60px; margin:-4px 18px 0px 0px;padding:0px;">00:11:28</span>
														</span>
													</a>   
													<ul class="submenu active">
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Party Go Front page</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Show user party join</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-play-circle"></i> Where to download source code through git repository</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
																												...
																												<li class="clsLecture clsoptions" >
															<div class="link">  
                                                                                                   <div class="col-md-9 padding"><p><i class="fa fa-file-alt"></i> Complete source code download</p></div>
                                                   <div class="col-md-2 padding">
                                                                                                   </div>
                                                                                                   																<div class="clear"></div>
															</div>
							...
							<div class="panel large-panel">
									...
									<img src="https://www.tutorialspoint.com/assets/profiles/179741/profile/200_140521-1583211640.jpg" title="Jack Chan"/>
									<h4><a href='https://www.tutorialspoint.com/videotutorials/profile/jack_chan' target='_blank' title='View Jack Chan Profile '>Jack Chan</a></h4>
									<h5>Educator / Software Engineer / Business Analyst in iBank</h5>
									<p><p>Hi, I&#39;m Jack. I have 10+ years of experience in the finance IT&nbsp;industry, have worked in top tier global investment banks like Morgan Stanley, Merrill Lynch, HSBC and BNP&nbsp;Paribas.</p><p>I started programming since I was 10. Since then, I felt in love with software engineering and went on to purse my degree in Information Engineering in university. I was an active participant in world wide programming contests. I had also go aboard to Singapore to work with the local professors to analyze gene data in a bioinformatic project. I learnt a great deal form that in my young age.</p><p>I&nbsp;have then been working in the finance IT industry for 10+ years. I worked with different top tier investment banks and has used my skill to build numerous robust systems for them. I have built systems that analyze millions of transactions and positions to spot suspicious movement. I&nbsp;have leveraged the powerful analytical Python libraries to perform data analysis and performance optimization for trading system that works in microsecond level. I have profound knowledge on the modern software development life cycle which use automated testing, continuous integration and agile methodology. I learnt different programming languages, including Java, C#, C++, Php, Python etc. But among them, I found python the most expressive and powerful, it is one of the best programing languages he will recommend to people.</p><p>If you like my work, you are welcome to contact me through my website, Facebook, linked-in etc.</p></p>             
								</div>
								
								<h3>More Courses from <a href="https://www.tutorialspoint.com/videotutorials/profile/jack_chan" target="_blank" title="View Jack Chan Profile">Jack Chan </a></h3><div>								<div class="col-md-4 col-sm-6 col-xs-12 padding-left">
									<div class="card center" id="divCourse1081">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/python_flask_and_sqlalchemy_orm/index.asp" title="Python Flask and SQLAlchemy ORM">
													<div class="card-content" title="Python Flask and SQLAlchemy ORM"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/1081/images/course_1081_image.jpg?t=1585073649" alt="Python Flask and SQLAlchemy ORM Image" />
														<div class="card-title" title="Python Flask and SQLAlchemy ORM">Python Flask and SQLAlchemy OR...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													...
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='1081'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
								  ...
								  <div class="clear"></div>
									...
									<div class="card center" id="divCourse1065">
										<div class="clsCourseDiv">
											<div class="card-content">    								
												<a href="https://www.tutorialspoint.com/learn_python_in_a_day_with_6_projects/index.asp" title="Learn Python In A Day With 6 Projects">
													<div class="card-content" title="Learn Python In A Day With 6 Projects"> 
														<img data-type="" data-ctype='C' data-progressive="" class="card-img-top img-fluid img-sub progressive-img progressive-not-loaded" src="https://www.tutorialspoint.com/videotutorials/assets/videos/courses/1065/images/course_1065_image.jpg?t=1585073649" alt="Learn Python In A Day With 6 Projects Image" />
														<div class="card-title" title="Learn Python In A Day With 6 Projects">Learn Python In A Day With 6 P...</div>
														<div class="clear"></div>
												  </div> 
												</a>
												<hr>
												<div class="col-12 padding">
													<div class="col-sm-6 col-7 text-center">
														...
														<strike>&#8377;9100</strike>&nbsp;&nbsp;<i class="fa fa-rupee-sign"></i>&nbsp;693																											</div>							
													<div class="col-sm-6 col-5 text-center">
														<div class='add-to-cart-form add-cart-sub' title='Add to Cart'><input type='hidden' name='couser_id' id='course_id' value='1065'> <span><i class='fa fa-plus '></i>&nbsp;<i class='fa fa-shopping-cart'> </i></span></div>   
													</div>
												</div>                       
												<div class="clear"></div>	
											</div>               
