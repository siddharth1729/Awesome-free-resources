...
<title>Online Algol Compiler - Online Algol Editor - Online Algol IDE - Algol Coding Online - Practice Algol Online - Execute Algol Online - Compile Algol Online - Run Algol Online</title>
<meta name="Description" content="Online Algol Compiler, Online Algol Editor, Online Algol IDE, Algol Coding Online, Practice Algol Online, Execute Algol Online, Compile Algol Online, Run Algol Online, Online Algol Interpreter, Execute ALGOL Online (Algol 68 Genie 2.8.4)"/>
<meta name="Keywords" content="Online Algol Compiler, Online Algol Editor, Online Algol IDE, Algol Coding Online, Practice Algol Online, Execute Algol Online, Compile Algol Online, Execute ALGOL Online (Algol 68 Genie 2.8.4), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute ALGOL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "a68g main.alg";
var filename = "main.alg";
var mainfile = "main.alg";
var modename = "c_cpp";
var version = "Algol 68 Genie 2.8.4";
var opt = "new";
var projectid = "";
var projecttitle = "Execute ALGOL Online";
var userid = 0;
var username = "root";
var ext = "alg";
</script>
