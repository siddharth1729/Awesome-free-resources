...
<title>Online D Compiler - Online D Editor - Online D IDE - D Coding Online - Practice D Online - Execute D Online - Compile D Online - Run D Online</title>
<meta name="Description" content="Online D Compiler, Online D Editor, Online D IDE, D Coding Online, Practice D Online, Execute D Online, Compile D Online, Run D Online, Online D Interpreter, Compile and Execute D Online (DMD64 v2.067.0)"/>
<meta name="Keywords" content="Online D Compiler, Online D Editor, Online D IDE, D Coding Online, Practice D Online, Execute D Online, Compile D Online, Compile and Execute D Online (DMD64 v2.067.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute D Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "d";
var preview = 0;
var compile = "dmd  *.d -ofmain.amx";
var execute = "main.amx";
var filename = "main.d";
var mainfile = "main.d";
var modename = "d";
var version = "DMD64 v2.067.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute D Online";
var userid = 0;
var username = "root";
var ext = "d";
</script>
