...
<title>Online Mozart Compiler - Online Mozart Editor - Online Mozart IDE - Mozart Coding Online - Practice Mozart Online - Execute Mozart Online - Compile Mozart Online - Run Mozart Online</title>
<meta name="Description" content="Online Mozart Compiler, Online Mozart Editor, Online Mozart IDE, Mozart Coding Online, Practice Mozart Online, Execute Mozart Online, Compile Mozart Online, Run Mozart Online, Online Mozart Interpreter, Compile and Execute Mozart-OZ Online (Mozart-OZ v2.0.0)"/>
<meta name="Keywords" content="Online Mozart Compiler, Online Mozart Editor, Online Mozart IDE, Mozart Coding Online, Practice Mozart Online, Execute Mozart Online, Compile Mozart Online, Compile and Execute Mozart-OZ Online (Mozart-OZ v2.0.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Mozart-OZ Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "mozart";
var preview = 0;
var compile = "ozc -c *.oz -o main.oza";
var execute = "ozengine main.oza";
var filename = "main.oz";
var mainfile = "main.oz";
var modename = "csharp";
var version = "Mozart-OZ v2.0.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Mozart-OZ Online";
var userid = 0;
var username = "root";
var ext = "oz";
</script>
