...
<title>Online Octave Compiler - Online Octave Editor - Online Octave IDE - Octave Coding Online - Practice Octave Online - Execute Octave Online - Compile Octave Online - Run Octave Online</title>
<meta name="Description" content="Online Octave Compiler, Online Octave Editor, Online Octave IDE, Octave Coding Online, Practice Octave Online, Execute Octave Online, Compile Octave Online, Run Octave Online, Online Octave Interpreter, Execute MATLAB/Octave Online (GNU Octave, v4.2.1)"/>
<meta name="Keywords" content="Online Octave Compiler, Online Octave Editor, Online Octave IDE, Octave Coding Online, Practice Octave Online, Execute Octave Online, Compile Octave Online, Execute MATLAB/Octave Online (GNU Octave, v4.2.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute MATLAB/Octave Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "octave -qf --no-window-system demo.m";
var filename = "demo.m";
var mainfile = "demo.m";
var modename = "matlab";
var version = "GNU Octave, v4.2.1";
var opt = "new";
var projectid = "";
var projecttitle = "Execute MATLAB/Octave Online";
var userid = 0;
var username = "root";
var ext = "m";
</script>
