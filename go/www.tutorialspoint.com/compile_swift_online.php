...
<title>Online Swift Compiler - Online Swift Editor - Online Swift IDE - Swift Coding Online - Practice Swift Online - Execute Swift Online - Compile Swift Online - Run Swift Online</title>
<meta name="Description" content="Online Swift Compiler, Online Swift Editor, Online Swift IDE, Swift Coding Online, Practice Swift Online, Execute Swift Online, Compile Swift Online, Run Swift Online, Online Swift Interpreter, Compile and Execute Swift Online (Swift 4.0)"/>
<meta name="Keywords" content="Online Swift Compiler, Online Swift Editor, Online Swift IDE, Swift Coding Online, Practice Swift Online, Execute Swift Online, Compile Swift Online, Compile and Execute Swift Online (Swift 4.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Swift Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "swift main.swift";
var filename = "main.swift";
var mainfile = "main.swift";
var modename = "swift";
var version = "Swift 4.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Swift Online";
var userid = 0;
var username = "root";
var ext = "swift";
</script>
