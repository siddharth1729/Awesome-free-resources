...
<title>Online Befunge Compiler - Online Befunge Editor - Online Befunge IDE - Befunge Coding Online - Practice Befunge Online - Execute Befunge Online - Compile Befunge Online - Run Befunge Online</title>
<meta name="Description" content="Online Befunge Compiler, Online Befunge Editor, Online Befunge IDE, Befunge Coding Online, Practice Befunge Online, Execute Befunge Online, Compile Befunge Online, Run Befunge Online, Online Befunge Interpreter, Compile and Execute Befunge Online (TBC v1.0)"/>
<meta name="Keywords" content="Online Befunge Compiler, Online Befunge Editor, Online Befunge IDE, Befunge Coding Online, Practice Befunge Online, Execute Befunge Online, Compile Befunge Online, Compile and Execute Befunge Online (TBC v1.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Befunge Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "befunge";
var preview = 0;
var compile = "tbc main.be >main.c; gcc -o main  main.c";
var execute = "main";
var filename = "main.be";
var mainfile = "main.be";
var modename = "text";
var version = "TBC v1.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Befunge Online";
var userid = 0;
var username = "root";
var ext = "be";
</script>
