...
<title>Online Cbasic Compiler - Online Cbasic Editor - Online Cbasic IDE - Cbasic Coding Online - Practice Cbasic Online - Execute Cbasic Online - Compile Cbasic Online - Run Cbasic Online</title>
<meta name="Description" content="Online Cbasic Compiler, Online Cbasic Editor, Online Cbasic IDE, Cbasic Coding Online, Practice Cbasic Online, Execute Cbasic Online, Compile Cbasic Online, Run Cbasic Online, Online Cbasic Interpreter, Execute Chipmunk Basic Online (Chipmunk BASIC)"/>
<meta name="Keywords" content="Online Cbasic Compiler, Online Cbasic Editor, Online Cbasic IDE, Cbasic Coding Online, Practice Cbasic Online, Execute Cbasic Online, Compile Cbasic Online, Execute Chipmunk Basic Online (Chipmunk BASIC), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Chipmunk Basic Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "basic main.bas";
var filename = "main.bas";
var mainfile = "main.bas";
var modename = "vbscript";
var version = "Chipmunk BASIC";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Chipmunk Basic Online";
var userid = 0;
var username = "root";
var ext = "bas";
</script>
