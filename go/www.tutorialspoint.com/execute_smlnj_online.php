...
<title>Online Smlnj Compiler - Online Smlnj Editor - Online Smlnj IDE - Smlnj Coding Online - Practice Smlnj Online - Execute Smlnj Online - Compile Smlnj Online - Run Smlnj Online</title>
<meta name="Description" content="Online Smlnj Compiler, Online Smlnj Editor, Online Smlnj IDE, Smlnj Coding Online, Practice Smlnj Online, Execute Smlnj Online, Compile Smlnj Online, Run Smlnj Online, Online Smlnj Interpreter, Execute SML/NJ Online (SML/NJ v110.78)"/>
<meta name="Keywords" content="Online Smlnj Compiler, Online Smlnj Editor, Online Smlnj IDE, Smlnj Coding Online, Practice Smlnj Online, Execute Smlnj Online, Compile Smlnj Online, Execute SML/NJ Online (SML/NJ v110.78), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute SML/NJ Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "sml < main.sml";
var filename = "main.sml";
var mainfile = "main.sml";
var modename = "sh";
var version = "SML/NJ v110.78";
var opt = "new";
var projectid = "";
var projecttitle = "Execute SML/NJ Online";
var userid = 0;
var username = "root";
var ext = "sml";
</script>
