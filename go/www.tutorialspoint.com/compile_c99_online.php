...
<title>Online C99 Compiler - Online C99 Editor - Online C99 IDE - C99 Coding Online - Practice C99 Online - Execute C99 Online - Compile C99 Online - Run C99 Online</title>
<meta name="Description" content="Online C99 Compiler, Online C99 Editor, Online C99 IDE, C99 Coding Online, Practice C99 Online, Execute C99 Online, Compile C99 Online, Run C99 Online, Online C99 Interpreter, Compile and Execute C99 Online (GNU GCC v7.1.1)"/>
<meta name="Keywords" content="Online C99 Compiler, Online C99 Editor, Online C99 IDE, C99 Coding Online, Practice C99 Online, Execute C99 Online, Compile C99 Online, Compile and Execute C99 Online (GNU GCC v7.1.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute C99 Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "c99";
var preview = 0;
var compile = "gcc -std=c99 -o main *.c";
var execute = "main";
var filename = "main.c";
var mainfile = "main.c";
var modename = "c_cpp";
...
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute C99 Online";
var userid = 0;
var username = "root";
var ext = "c";
</script>
