...
<title>Online Cobol Compiler - Online Cobol Editor - Online Cobol IDE - Cobol Coding Online - Practice Cobol Online - Execute Cobol Online - Compile Cobol Online - Run Cobol Online</title>
<meta name="Description" content="Online Cobol Compiler, Online Cobol Editor, Online Cobol IDE, Cobol Coding Online, Practice Cobol Online, Execute Cobol Online, Compile Cobol Online, Run Cobol Online, Online Cobol Interpreter, Compile and Execute COBOL Online (GnuCOBOL v2.2)"/>
<meta name="Keywords" content="Online Cobol Compiler, Online Cobol Editor, Online Cobol IDE, Cobol Coding Online, Practice Cobol Online, Execute Cobol Online, Compile Cobol Online, Compile and Execute COBOL Online (GnuCOBOL v2.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute COBOL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "cobol";
var preview = 0;
var compile = "cobc -x -free *.cobc -o main";
var execute = "main";
var filename = "main.cobc";
var mainfile = "main.cobc";
var modename = "cobol";
var version = "GnuCOBOL v2.2";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute COBOL Online";
var userid = 0;
var username = "root";
var ext = "cobc";
</script>
