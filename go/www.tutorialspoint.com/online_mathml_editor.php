...
<title>Online Mathml Compiler - Online Mathml Editor - Online Mathml IDE - Mathml Coding Online - Practice Mathml Online - Execute Mathml Online - Compile Mathml Online - Run Mathml Online</title>
<meta name="Description" content="Online Mathml Compiler, Online Mathml Editor, Online Mathml IDE, Mathml Coding Online, Practice Mathml Online, Execute Mathml Online, Compile Mathml Online, Run Mathml Online, Online Mathml Interpreter, Online MathML Editor (MathJax v2.2)"/>
<meta name="Keywords" content="Online Mathml Compiler, Online Mathml Editor, Online Mathml IDE, Mathml Coding Online, Practice Mathml Online, Execute Mathml Online, Compile Mathml Online, Online MathML Editor (MathJax v2.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<input type="hidden" name="uid" value="2996821"/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Online MathML Editor</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var modename = "html";
var version = "MathJax v2.2";
var opt = "new";
var projectid = "";
var projecttitle = "Online MathML Editor";
var userid = 0;
var username = "root";
var ext = "js";
</script>
