...
<title>Online Haxe Compiler - Online Haxe Editor - Online Haxe IDE - Haxe Coding Online - Practice Haxe Online - Execute Haxe Online - Compile Haxe Online - Run Haxe Online</title>
<meta name="Description" content="Online Haxe Compiler, Online Haxe Editor, Online Haxe IDE, Haxe Coding Online, Practice Haxe Online, Execute Haxe Online, Compile Haxe Online, Run Haxe Online, Online Haxe Interpreter, Execute Haxe Online (Haxe v3.4.2)"/>
<meta name="Keywords" content="Online Haxe Compiler, Online Haxe Editor, Online Haxe IDE, Haxe Coding Online, Practice Haxe Online, Execute Haxe Online, Compile Haxe Online, Execute Haxe Online (Haxe v3.4.2), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Haxe Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "haxe -main HelloWorld --interp";
var filename = "HelloWorld.hx";
var mainfile = "HelloWorld.hx";
var modename = "haxe";
var version = "Haxe v3.4.2";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Haxe Online";
var userid = 0;
var username = "root";
var ext = "hx";
</script>
