...
<title>Online Awk Compiler - Online Awk Editor - Online Awk IDE - Awk Coding Online - Practice Awk Online - Execute Awk Online - Compile Awk Online - Run Awk Online</title>
<meta name="Description" content="Online Awk Compiler, Online Awk Editor, Online Awk IDE, Awk Coding Online, Practice Awk Online, Execute Awk Online, Compile Awk Online, Run Awk Online, Online Awk Interpreter, Execute Awk Online (GNU Awk v4.1.4)"/>
<meta name="Keywords" content="Online Awk Compiler, Online Awk Editor, Online Awk IDE, Awk Coding Online, Practice Awk Online, Execute Awk Online, Compile Awk Online, Execute Awk Online (GNU Awk v4.1.4), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Awk Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "awk -f main.awk";
var filename = "main.awk";
var mainfile = "main.awk";
var modename = "sh";
var version = "GNU Awk v4.1.4";
var opt = "new";
var projectid = "";
var projecttitle = "Execute Awk Online";
var userid = 0;
var username = "root";
var ext = "awk";
</script>
