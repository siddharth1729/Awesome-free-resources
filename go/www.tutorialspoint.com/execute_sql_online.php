...
<title>Online Sqlite Compiler - Online Sqlite Editor - Online Sqlite IDE - Sqlite Coding Online - Practice Sqlite Online - Execute Sqlite Online - Compile Sqlite Online - Run Sqlite Online</title>
<meta name="Description" content="Online Sqlite Compiler, Online Sqlite Editor, Online Sqlite IDE, Sqlite Coding Online, Practice Sqlite Online, Execute Sqlite Online, Compile Sqlite Online, Run Sqlite Online, Online Sqlite Interpreter, Execute SQL Online (SQLite v3.20.1)"/>
<meta name="Keywords" content="Online Sqlite Compiler, Online Sqlite Editor, Online Sqlite IDE, Sqlite Coding Online, Practice Sqlite Online, Execute Sqlite Online, Compile Sqlite Online, Execute SQL Online (SQLite v3.20.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute SQL Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "sqlite3 database.sdb < main.sql";
var filename = "main.sql";
var mainfile = "main.sql";
var modename = "sql";
var version = "SQLite v3.20.1";
var opt = "new";
var projectid = "";
var projecttitle = "Execute SQL Online";
var userid = 0;
var username = "root";
var ext = "sql";
</script>
