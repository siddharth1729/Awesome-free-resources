...
<title>Online Simula Compiler - Online Simula Editor - Online Simula IDE - Simula Coding Online - Practice Simula Online - Execute Simula Online - Compile Simula Online - Run Simula Online</title>
<meta name="Description" content="Online Simula Compiler, Online Simula Editor, Online Simula IDE, Simula Coding Online, Practice Simula Online, Execute Simula Online, Compile Simula Online, Run Simula Online, Online Simula Interpreter, Compile and Execute Simula Online (Cim v3.37)"/>
<meta name="Keywords" content="Online Simula Compiler, Online Simula Editor, Online Simula IDE, Simula Coding Online, Practice Simula Online, Execute Simula Online, Compile Simula Online, Compile and Execute Simula Online (Cim v3.37), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute Simula Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "simula";
var preview = 0;
var compile = "cim -o main -w *.sim";
var execute = "main";
var filename = "main.sim";
var mainfile = "main.sim";
var modename = "c_cpp";
var version = "Cim v3.37";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute Simula Online";
var userid = 0;
var username = "root";
var ext = "sim";
</script>
