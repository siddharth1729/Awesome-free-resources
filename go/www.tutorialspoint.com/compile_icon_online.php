...
<title>Online Icon Compiler - Online Icon Editor - Online Icon IDE - Icon Coding Online - Practice Icon Online - Execute Icon Online - Compile Icon Online - Run Icon Online</title>
<meta name="Description" content="Online Icon Compiler, Online Icon Editor, Online Icon IDE, Icon Coding Online, Practice Icon Online, Execute Icon Online, Compile Icon Online, Run Icon Online, Online Icon Interpreter, Compile and Execute ICON Online (Icon v9.5.0)"/>
<meta name="Keywords" content="Online Icon Compiler, Online Icon Editor, Online Icon IDE, Icon Coding Online, Practice Icon Online, Execute Icon Online, Compile Icon Online, Compile and Execute ICON Online (Icon v9.5.0), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute ICON Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var langid = "icon";
var preview = 0;
var compile = "icont -o main *.icn";
var execute = "main";
var filename = "main.icn";
var mainfile = "main.icn";
var modename = "sh";
var version = "Icon v9.5.0";
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute ICON Online";
var userid = 0;
var username = "root";
var ext = "icn";
</script>
