...
<title>Online C++ Compiler - Online C++ Editor - Online C++ IDE - C++ Coding Online - Practice C++ Online - Execute C++ Online - Compile C++ Online - Run C++ Online</title>
<meta name="Description" content="Online C++ Compiler, Online C++ Editor, Online C++ IDE, C++ Coding Online, Practice C++ Online, Execute C++ Online, Compile C++ Online, Run C++ Online, Online C++ Interpreter, Compile and Execute C++ Online (GNU GCC v7.1.1)"/>
<meta name="Keywords" content="Online C++ Compiler, Online C++ Editor, Online C++ IDE, C++ Coding Online, Practice C++ Online, Execute C++ Online, Compile C++ Online, Compile and Execute C++ Online (GNU GCC v7.1.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Compile and Execute C++ Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var opt = "new";
var projectid = "";
var projecttitle = "Compile and Execute C++ Online";
var userid = 0;
var username = "root";
var ext = "cpp";
</script>
