...
<title>Online Ruby Compiler - Online Ruby Editor - Online Ruby IDE - Ruby Coding Online - Practice Ruby Online - Execute Ruby Online - Compile Ruby Online - Run Ruby Online</title>
<meta name="Description" content="Online Ruby Compiler, Online Ruby Editor, Online Ruby IDE, Ruby Coding Online, Practice Ruby Online, Execute Ruby Online, Compile Ruby Online, Run Ruby Online, Online Ruby Interpreter, Execute Ruby Online (Ruby v2.4.1)"/>
<meta name="Keywords" content="Online Ruby Compiler, Online Ruby Editor, Online Ruby IDE, Ruby Coding Online, Practice Ruby Online, Execute Ruby Online, Compile Ruby Online, Execute Ruby Online (Ruby v2.4.1), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute Ruby Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var opt = "new";
var projectid = "";
var projecttitle = "Execute Ruby Online";
var userid = 0;
var username = "root";
var ext = "rb";
</script>
