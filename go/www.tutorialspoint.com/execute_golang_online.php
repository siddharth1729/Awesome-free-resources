...
<title>Online Golang Compiler - Online Golang Editor - Online Golang IDE - Golang Coding Online - Practice Golang Online - Execute Golang Online - Compile Golang Online - Run Golang Online</title>
<meta name="Description" content="Online Golang Compiler, Online Golang Editor, Online Golang IDE, Golang Coding Online, Practice Golang Online, Execute Golang Online, Compile Golang Online, Run Golang Online, Online Golang Interpreter, Execute GO Language Online (Go v1.8.3)"/>
<meta name="Keywords" content="Online Golang Compiler, Online Golang Editor, Online Golang IDE, Golang Coding Online, Practice Golang Online, Execute Golang Online, Compile Golang Online, Execute GO Language Online (Go v1.8.3), compile, execute, programs, online, linux, experience, cloud, computing, source code, dropbox, googledrive, onedrive, programming, java, jsp, cold fusion, c, c++, pascal, fortran, php, perl, ruby, python, browsers, iphones, ipads, smart tv."/>
...
<div data-options="region:'north'" id="north" style="height:55px; width:100%;overflow:hidden;background:url(/images/top_bg.png); ">
   ...
   <h1 class="main-title" id="main-title">Execute GO Language Online</h1><span id="edit-title"><a href="javascript:void(0);" class="easyui-linkbutton" onclick="setProjectTitle()" data-options="plain:true,iconCls:'icon-edit'" style="float:right"></a></span>
...
var preview = 0;
var compile = "0";
var execute = "go run main.go";
var filename = "main.go";
var mainfile = "main.go";
var modename = "golang";
var version = "Go v1.8.3";
var opt = "new";
var projectid = "";
var projecttitle = "Execute GO Language Online";
var userid = 0;
var username = "root";
var ext = "go";
</script>
